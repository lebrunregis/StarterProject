...
namespace RelationsInspector.Backend.Scene
{
    ...
    {
        private RelationsInspectorAPI api;
        private Object sceneObj;    // representing the scene, as a parent for all the top-level GameObjects in the hierarchy
        private static bool includeComponents;
