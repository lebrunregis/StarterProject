...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_ScaleSpring : MMF_Feedback
    {
        ...
        public Vector3 MoveToScaleMin = new(1f, 1f, 1f);
        ...
        [MMFEnumCondition("Mode", (int)Modes.MoveTo, (int)Modes.MoveToAdditive)]
        public Vector3 MoveToScaleMax = new(2f, 2f, 2f);
        ...
        public Vector3 BumpScaleMin = new(20f, 20f, 20f);
        ...
        [MMFEnumCondition("Mode", (int)Modes.Bump)]
        public Vector3 BumpScaleMax = new(30f, 30f, 30f);
