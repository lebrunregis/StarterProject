...
namespace AmplifyShaderEditor
{
    public partial class Preferences
    {
        public class Project
        {
            ...
            {
                public static readonly GUIContent AutoSRP = new("Auto import SRP shader templates", "By default Amplify Shader Editor checks for your SRP version and automatically imports the correct corresponding shader templates.\nTurn this OFF if you prefer to import them manually.");
                public static readonly GUIContent DefineSymbol = new("Add Amplify Shader Editor define symbol", "Turning it OFF will disable the automatic insertion of the define symbol and remove it from the list while turning it ON will do the opposite.\nThis is used for compatibility with other plugins, if you are not sure if you need this leave it ON.");
                public static readonly GUIContent TemplateExtensions = new("Template Extensions", "Supported file extensions for parsing shader templates.");
            }
            ...
            private static readonly string FullPath = Path.GetFullPath(RelativePath);
            private static Layout Values = new();
