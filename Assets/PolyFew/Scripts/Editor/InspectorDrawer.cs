...
namespace BrainFailProductions.PolyFew
{
    ...
    public class InspectorDrawer : Editor
    {
        ...
        private static readonly string sphereColHex = "#FBFF00C8";
...
#pragma warning disable
        ...
        void OnEnable()
        {
            ...
            if (Selection.gameObjects != null && Selection.gameObjects.Length > 1)
            {
                ...
                foreach (GameObject selected in Selection.gameObjects)
                {
                    if (selected.activeSelf && selected.GetComponent<PolyFew>() != null)
                    {
                        ...
                        {
                            dataContainer = selected.GetComponent<PolyFew>().dataContainer = new DataContainer();
                        }
            ...
            else if (Selection.activeGameObject != null && Selection.activeGameObject.GetComponent<PolyFew>() != null)
            {
                ...
                if (dataContainer == null)
                {
                    dataContainer = thisGameObject.GetComponent<PolyFew>().dataContainer = new DataContainer();
                }
        ...
        public void OnDestroy()
        {
            ...
            if (dataContainer != null && ReductionPending)
            {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isFeasibleTargetForPolyFew)
            {
                ...
                if (isPlainSkin)
                {
                    if (GUILayout.Button("<size=14><b>POLY FEW</b></size> <size=7><b>v7.82</b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                else
                {
                    if (GUILayout.Button("<size=14><color=#A52A2AFF><b>POLY FEW</b></color></size> <size=7><b><color=#A52A2AFF>v7.82</color></b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
...
#pragma warning disable
                    ...
                    content.tooltip = "The agressiveness of the reduction algorithm. Higher number equals higher quality, but more expensive to run. Lowest value is 7. Only valid if \"Use Edge Sort\" is unchecked.";
                        ...
                        for (int a = 0; a < dataContainer.currentLodLevelSettings.Count; a++)
                        {
                            ...
                            if (a != 0)
                            {
                                ...
                                if (lodLevel.simplificationOptionsFoldout)
                                {
                                    ...
                                    EditorGUI.BeginDisabledGroup(lodLevel.useEdgeSort);
        ...
        public void DrawBatchFewUI(bool boxDrawnAlready = false)
        {
            ...
            if (FoldoutBatchFew)
            {
                ...
                if (didPressButton)
                {
                    int choiceColorSpace = dataContainer.choiceDiffuseColorSpace;
                    CombiningInformation.DiffuseColorSpace colorSpace = choiceColorSpace == 0 ? CombiningInformation.DiffuseColorSpace.NON_LINEAR : CombiningInformation.DiffuseColorSpace.LINEAR;
...
#region ALPHA CUTOFF
        ...
        private void SetObjectMeshPairsIfNull()
        {
            ...
            if (dataContainer == null || Selection.activeGameObject == null) { return; }
        ...
        class BuildProcessor : IPreprocessBuildWithReport
        {
            ...
            public void OnPreprocessBuild(BuildReport report)
            {
                ...
                {
                    Scene scene = UnityEngine.SceneManagement.SceneManager.GetSceneAt(a);
