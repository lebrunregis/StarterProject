...
namespace AmplifyShaderEditor
{
    ...
    public class ASEPPSHelperTool : EditorWindow
    {
        ...
        "\t[{0}Tooltip( \"{1}\" )]\n" +
        "\tpublic {2} {3} = new {2} {{ {4} }};\n";
        public static readonly Dictionary<WirePortDataType, string> WireToPPSType = new()
        {
        ...
        public static readonly Dictionary<WirePortDataType, string> WireToPPSValueSet = new()
        {
        ...
        public static readonly Dictionary<UnityEngine.Rendering.ShaderPropertyType, string> ShaderPropertyToPPSType = new()
        {
        ...
        public static readonly Dictionary<UnityEngine.Rendering.ShaderPropertyType, string> ShaderPropertyToPPSSet = new()
        {
        ...
        private readonly Dictionary<string, bool> m_excludedProperties = new()
        {
            { "_texcoord",true },
            { "__dirty",true}
        };
        ...
        [SerializeField]
        private List<ASEPPSHelperBuffer> m_tooltips = new();
