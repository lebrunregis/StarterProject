...
{
    [Serializable]
    internal class ColorMaskHelper
    {
        private readonly GUIContent ColorMaskContent = new("Color Mask", "Sets color channel writing mask, turning all off makes the object completely invisible\nDefault: RGBA");
        ...
        [SerializeField]
        private InlineProperty m_inlineMask = new();
