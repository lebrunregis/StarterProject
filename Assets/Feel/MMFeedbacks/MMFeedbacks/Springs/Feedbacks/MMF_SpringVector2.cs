...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_SpringVector2 : MMF_Feedback
    {
        ...
        public Vector2 MoveToValue = new(2f, 2f);
        ...
        public Vector2 BumpAmount = new(75f, 75f);
        ...
        public Vector2 MoveToRandomValueMin = new(-2f, -2f);
        ...
        [MMEnumCondition("Command", (int)SpringCommands.MoveToRandom)]
        public Vector2 MoveToRandomValueMax = new(2f, 2f);
        ...
        public Vector2 BumpAmountRandomValueMin = new(-20f, -20f);
        ...
        [MMEnumCondition("Command", (int)SpringCommands.BumpRandom)]
        public Vector2 BumpAmountRandomValueMax = new(20f, 20f);
        ...
        public Vector2 NewDamping = new(0.8f, 0.8f);
        ...
        public Vector2 NewFrequency = new(5f, 5f);
