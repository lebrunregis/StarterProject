                                              ...
                                              bool initialize)
        {
            ...
            if (initialize)
            {
                ...
                if (Application.isPlaying)
                {
                    ...
                    if (dropdownLocalizer != null)
                    {
                        dropdownLocalizer.OptionKeys = optionsList;
                        dropdownLocalizer.AssignProvider(settings.LocalizationProvider, false);
                        dropdownLocalizer.Localize();
                    }
                }
                #endregion
            }
