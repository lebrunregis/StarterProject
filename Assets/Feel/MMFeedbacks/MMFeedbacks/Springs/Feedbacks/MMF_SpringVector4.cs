...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_SpringVector4 : MMF_Feedback
    {
        ...
        public Vector4 MoveToValue = new(2f, 2f, 2f, 2f);
        ...
        public Vector4 BumpAmount = new(75f, 75f, 75f, 75f);
        ...
        public Vector4 MoveToRandomValueMin = new(-2f, -2f, -2f, -2f);
        ...
        [MMEnumCondition("Command", (int)SpringCommands.MoveToRandom)]
        public Vector4 MoveToRandomValueMax = new(2f, 2f, 2f, 2f);
        ...
        public Vector4 BumpAmountRandomValueMin = new(-20f, -20f, -20f, -20f);
        ...
        [MMEnumCondition("Command", (int)SpringCommands.BumpRandom)]
        public Vector4 BumpAmountRandomValueMax = new(20f, 20f, 20f, 20f);
        ...
        public Vector4 NewDamping = new(0.8f, 0.8f, 0.8f, 0.8f);
        ...
        public Vector4 NewFrequency = new(5f, 5f, 5f, 5f);
