...
namespace AmplifyShaderEditor
{
    ...
    public class PropertyNode : ParentNode
    {
        ...
        [SerializeField]
        private List<string> m_enumNames = new();

        [SerializeField]
        private List<int> m_enumValues = new();
        ...
        [SerializeField]
        private List<string> m_customAttr = new();

        [SerializeField]
        private bool m_hasHeaders = false;

        [SerializeField]
        private List<string> m_headerAttributeValues = new();
        ...
        protected List<PropertyAttributes> m_availableAttribs = new();
        ...
        [SerializeField]
        protected List<int> m_selectedAttribs = new();
        ...
        private void InitializeAttribsArray()
        {
        ...
        private void DrawAttributesAddRemoveButtons()
        {
        ...
        private void CheckEnumAttribute()
        {
            m_hasEnum = false;
        ...
        private void DrawEnumAddRemoveButtons()
        {
            // Add new port
        ...
        private int IdForAttrib(string name)
        {
