...
namespace AmplifyShaderEditor
{
    ...
    public class FunctionNode : ParentNode
    {
        ...
        private Dictionary<int, FunctionInput> m_allFunctionInputsDict = new();

        [SerializeField]
        private List<FunctionOutput> m_allFunctionOutputs;
        private Dictionary<int, FunctionOutput> m_allFunctionOutputsDict = new();

        [SerializeField]
        private List<FunctionSwitch> m_allFunctionSwitches;
        private Dictionary<int, FunctionSwitch> m_allFunctionSwitchesDict = new();
        ...
        [SerializeField]
        private List<AdditionalDirectiveContainer> m_directives = new();
        ...
        private bool m_portsChanged = false;
        //[SerializeField]
        private bool m_initialGraphDraw = false;
        ...
        private Dictionary<int, bool> m_duplicatesBuffer = new();
        ...
        private void InputPortSwitchRestriction(WirePort port)
        {
        ...
        private void OutputPortSwitchRestriction(WirePort port)
        {
            switch (port.DataType)
            {
                case WirePortDataType.OBJECT:
