...
namespace DarkTonic.MasterAudio
{
    ...
    public static class AudioAddressableOptimizer
    {
        ...
        private static readonly Dictionary<string, AddressableTracker<AudioClip>> AddressableTasksByAddressableId = new();
        private static readonly object SyncRoot = new(); // to lock below
