...
namespace AmplifyShaderEditor
{
    ...
    public sealed class CommentaryNode : ParentNode, ISerializationCallbackReceiver
    {
        ...
        private readonly Vector2 ResizeButtonPos = new(1, 1);
        ...
        [SerializeField]
        private List<ParentNode> m_nodesOnCommentary = new();
        private readonly Dictionary<int, ParentNode> m_nodesOnCommentaryDict = new();
        ...
        private readonly List<int> m_nodesIds = new();
