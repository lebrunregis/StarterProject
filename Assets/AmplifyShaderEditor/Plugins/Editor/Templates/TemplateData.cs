...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateData : TemplateDataParent
    {
        ...
        [SerializeField]
        private List<TemplateProperty> m_propertyList = new();
        private Dictionary<string, TemplateProperty> m_propertyDict = new();

        [SerializeField]
        private List<TemplateInputData> m_inputDataList = new();
        private Dictionary<int, TemplateInputData> m_inputDataDict = new();
        ...
        [SerializeField]
        private List<TemplateLocalVarData> m_localVarsList = new();

        [SerializeField]
        private VertexDataContainer m_vertexDataContainer = new();

        [SerializeField]
        private TemplateInterpData m_interpolatorDataContainer;

        [SerializeField]
        private List<TemplateShaderPropertyData> m_availableShaderProperties = new();
        ...
        private void LoadTemplateBody(string body)
        {
        ...
        private void FetchSubShaderProperties()
        {
        ...
        private void FetchCommonTags()
        {
            ...
            try
            {
                Dictionary<string, TemplateShaderPropertyData> duplicatesHelper = new();
        ...
        private void FetchCodeAreas(string begin, MasterNodePortCategory category)
        {
        ...
        private void FetchInputs(MasterNodePortCategory portCategory)
        {
        ...
        {
            TemplateInputData inputData = new(tagStartIdx, tagStartIdx, tagId, portName, defaultValue, dataType, portCategory, portUniqueId, portOrderId, string.Empty);
