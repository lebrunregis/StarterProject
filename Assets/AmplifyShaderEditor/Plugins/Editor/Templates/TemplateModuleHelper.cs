...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateModulesHelper
    {
        ...
        [SerializeField]
        private TemplatesBlendModule m_blendOpHelper = new();

        [SerializeField]
        private TemplatesBlendModule m_blendOpHelper1 = new();

        [SerializeField]
        private TemplatesBlendModule m_blendOpHelper2 = new();

        [SerializeField]
        private TemplatesBlendModule m_blendOpHelper3 = new();

        [SerializeField]
        private TemplateAlphaToMaskModule m_alphaToMaskHelper = new();

        [SerializeField]
        private TemplateCullModeModule m_cullModeHelper = new();

        [SerializeField]
        private TemplateColorMaskModule m_colorMaskHelper = new();

        [SerializeField]
        private TemplateColorMaskModule m_colorMaskHelper1 = new();

        [SerializeField]
        private TemplateColorMaskModule m_colorMaskHelper2 = new();

        [SerializeField]
        private TemplateColorMaskModule m_colorMaskHelper3 = new();

        [SerializeField]
        private TemplatesStencilBufferModule m_stencilBufferHelper = new();

        [SerializeField]
        private TemplateDepthModule m_depthOphelper = new();

        [SerializeField]
        private TemplateTagsModule m_tagsHelper = new();

        [SerializeField]
        private TemplateShaderModelModule m_shaderModelHelper = new();

        [SerializeField]
        private TemplateAdditionalIncludesHelper m_additionalIncludes = new();

        [SerializeField]
        private TemplateAdditionalDefinesHelper m_additionalDefines = new();

        [SerializeField]
        private TemplateAdditionalPragmasHelper m_additionalPragmas = new();

        [SerializeField]
        private TemplateAdditionalDirectivesHelper m_additionalDirectives = new(" Additional Directives");

        [SerializeField]
        private RenderingPlatformOpHelper m_renderingPlatforms = new();
