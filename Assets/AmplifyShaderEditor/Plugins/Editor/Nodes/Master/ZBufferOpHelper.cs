...
namespace AmplifyShaderEditor
{
    ...
    [Serializable]
    internal class ZBufferOpHelper
    {
        ...
        public static readonly Dictionary<ZTestMode, int> ZTestModeDict = new()
        {
            {ZTestMode.Less,1 },
            {ZTestMode.Greater,2},
            {ZTestMode.LEqual,3},
        ...
        public static readonly Dictionary<ZWriteMode, int> ZWriteModeDict = new()
        {
            { ZWriteMode.On,1},
            { ZWriteMode.Off,2}
        };
        ...
        [SerializeField]
        private InlineProperty m_zTestMode = new();

        [SerializeField]
        private InlineProperty m_zWriteMode = new();
        [SerializeField]
        private InlineProperty m_offsetFactor = new();

        [SerializeField]
        private InlineProperty m_offsetUnits = new();
