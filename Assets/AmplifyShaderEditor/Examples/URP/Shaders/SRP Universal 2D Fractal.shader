	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord4 = input.ase_texcoord9.xy * float2( 2,2 ) + float2( -1,-1 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float saferPower25 = abs( _ZoomBase );
				float2 texCoord4 = input.ase_texcoord4.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV3 = ( ( pow( saferPower25 , (sin( _TimeParameters.x * 0.5 )*_ZoomScale + _ZoomOffset) ) * texCoord4 ) + _Center );
				int MaxIter3 = _MaxIter;
				float Threshold3 = _Threshold;
				float localMandlebrot3 = Mandlebrot3( UV3 , MaxIter3 , Threshold3 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float saferPower25 = abs( _ZoomBase );
				float2 texCoord4 = input.ase_texcoord2.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV3 = ( ( pow( saferPower25 , (sin( _TimeParameters.x * 0.5 )*_ZoomScale + _ZoomOffset) ) * texCoord4 ) + _Center );
				int MaxIter3 = _MaxIter;
				float Threshold3 = _Threshold;
				float localMandlebrot3 = Mandlebrot3( UV3 , MaxIter3 , Threshold3 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float saferPower25 = abs( _ZoomBase );
				float2 texCoord4 = input.ase_texcoord5.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV3 = ( ( pow( saferPower25 , (sin( _TimeParameters.x * 0.5 )*_ZoomScale + _ZoomOffset) ) * texCoord4 ) + _Center );
				int MaxIter3 = _MaxIter;
				float Threshold3 = _Threshold;
				float localMandlebrot3 = Mandlebrot3( UV3 , MaxIter3 , Threshold3 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float saferPower25 = abs( _ZoomBase );
				float2 texCoord4 = input.ase_texcoord.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV3 = ( ( pow( saferPower25 , (sin( _TimeParameters.x * 0.5 )*_ZoomScale + _ZoomOffset) ) * texCoord4 ) + _Center );
				int MaxIter3 = _MaxIter;
				float Threshold3 = _Threshold;
				float localMandlebrot3 = Mandlebrot3( UV3 , MaxIter3 , Threshold3 );
...
ASEEND*/
//CHKSM=034DC88FC45AC502C1F9C9022D426276B15738BA