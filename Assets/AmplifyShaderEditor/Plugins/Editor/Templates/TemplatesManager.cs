...
namespace AmplifyShaderEditor
{
            ...
            if (propertyIndex > -1)
            {
                if (searchIndentation)
                {
                    ...
                    if (identationIndex > -1)
                    {
                        ...
                        TemplateProperty templateProperty = new(ID, indentation, false);
                        m_propertyList.Add(templateProperty);
                        m_propertyDict.Add(templateProperty.Id, templateProperty);
                    }
                    else
                    {
                        TemplateProperty templateProperty = new(ID, string.Empty, false);
                        m_propertyList.Add(templateProperty);
                        m_propertyDict.Add(templateProperty.Id, templateProperty);
                    }
                }
                ...
                {
                    TemplateProperty templateProperty = new(ID, customIndentation, true);
                    m_propertyList.Add(templateProperty);
                    m_propertyDict.Add(templateProperty.Id, templateProperty);
                }
            }
    ...
    public class TemplatesManager : ScriptableObject
    {
        ...
        public static readonly TemplateTagData[] CommonTags = { new( TemplatePropertyTag,true),
                                                                new( TemplateGlobalsTag,true),
                                                                new( TemplateSRPBatcherTag,true),
                                                                new( TemplateFunctionsTag,true),
																//new TemplateTagData( TemplateTagsTag,false," "),
																new( TemplatePragmaBeforeTag,true),
                                                                new( TemplatePragmaTag,true),
                                                                new( TemplatePassTag,true),
                                                                new( TemplateInputsVertParamsTag,false),
                                                                new( TemplateInputsFragParamsTag,false),
                                                                new( TemplateLODsTag,true)
        ...
        public static Dictionary<string, string> DeprecatedTemplates = new()
        {
        };

        public static Dictionary<string, string> OfficialTemplates = new()
        {
        ...
        private Dictionary<string, TemplateDataParent> m_availableTemplates = new();

        [SerializeField]
        private List<TemplateDataParent> m_sortedTemplates = new();
        ...
        private readonly Dictionary<string, bool> m_optionsInitialSetup = new();
        ...
        private struct TemplateDescriptor
        {
        ...
        public void CreateTemplateMenuItems()
        {
            ...
            System.Text.StringBuilder fileContents = new();
