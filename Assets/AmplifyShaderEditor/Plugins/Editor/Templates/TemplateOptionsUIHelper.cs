...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateOptionsUIHelper
    {
        ...
        private readonly bool m_isSubShader = false;
        ...
        [SerializeField]
        private List<TemplateOptionUIItem> m_passCustomOptionsUI = new();

        [NonSerialized]
        private Dictionary<string, TemplateOptionUIItem> m_passCustomOptionsUIDict = new();
        ...
        [SerializeField]
        private List<TemplateOptionPortItem> m_passCustomOptionsPorts = new();
                ...
                for (int i = 0; i < customOptionsContainer.Options.Length; i++)
                {
                    switch (customOptionsContainer.Options[i].Type)
                    {
                        case AseOptionsType.Option:
                            {
                                TemplateOptionUIItem item = new(customOptionsContainer.Options[i]);
                                if (m_isSubShader)
                                {
                        ...
                        case AseOptionsType.Port:
                            {
                                TemplateOptionPortItem item = new(owner, customOptionsContainer.Options[i]);
