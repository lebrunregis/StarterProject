...
namespace AmplifyShaderEditor
{
    ...
    {
        [SerializeField]
        private List<PropertyDataCollector> m_directivesList = new();

        [NonSerialized]
        private Dictionary<string, PropertyDataCollector> m_directivesDict = new();
        ...
        public void AddDirective(string directive, bool temporary, bool isPragma = false)
        {
            ...
            if (!m_directivesDict.ContainsKey(directive))
            {
                ...
                PropertyDataCollector data = new(nodeId, directive, -1, isPragma);
