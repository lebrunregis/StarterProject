...
namespace AmplifyShaderEditor
{
    ...
    public class BlendOpsHelper
    {
        ...
        [SerializeField]
        private InlineProperty m_sourceFactorRGB = new(0);

        [SerializeField]
        private InlineProperty m_destFactorRGB = new(0);
        ...
        [SerializeField]
        private InlineProperty m_sourceFactorAlpha = new(0);

        [SerializeField]
        private InlineProperty m_destFactorAlpha = new(0);
        ...
        [SerializeField]
        private InlineProperty m_blendOpRGB = new(0);

        [SerializeField]
        private InlineProperty m_blendOpAlpha = new(0);
