...
namespace CitrioN.Common.Editor
{
    public class ClassDropdown : AdvancedDropdown
    {
        ...
        private readonly Action<ClassDropdownItem> onClassItemSelected = null;
        private readonly string stringToReplace = null;
        private readonly string replacementString = string.Empty;

        private List<AdvancedDropdownItem> dropdownItems = new();
        private readonly Dictionary<AdvancedDropdownItem, int> itemOrder = new();
        private readonly Dictionary<AdvancedDropdownItem, List<AdvancedDropdownItem>> itemHierarchies =
      new();
