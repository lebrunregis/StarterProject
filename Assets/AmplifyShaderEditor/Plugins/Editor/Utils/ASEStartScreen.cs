...
namespace AmplifyShaderEditor
{
    public class ASEStartScreen : EditorWindow
    {
        ...
        private static readonly GUIContent SamplesTitle = new("Shader Samples", "Import samples according to you project rendering pipeline");
        private static readonly GUIContent ResourcesTitle = new("Learning Resources", "Check the online wiki for various topics about how to use ASE with node examples and explanations");
        ...
        private static readonly GUIContent UpdateTitle = new("Latest Update", "Check the lastest additions, improvements and bug fixes done to ASE");
        private static readonly GUIContent ASETitle = new("Amplify Shader Editor", "Are you using the latest version? Now you know");
        ...
        private GUIContent Basicbutton = null;
        private GUIContent Beginnerbutton = null;
        private GUIContent Nodesbutton = null;
        private GUIContent SRPusebutton = null;
        private GUIContent Functionsbutton = null;
        private GUIContent Templatesbutton = null;
        private GUIContent APIbutton = null;
        private GUIContent SGtoASEbutton = null;

        private GUIContent DiscordButton = null;
        private GUIContent ForumButton = null;

        private GUIContent ASEIcon = null;
        ...
        private static readonly Dictionary<int, ASESRPPackageDesc> m_srpSamplePackages = new()
        {
