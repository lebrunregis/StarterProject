...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Rotation : MMF_Feedback
    {
        ...
        public MMTweenType AnimateRotationTweenX = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "AnimateX");
        ...
        public MMTweenType AnimateRotationTweenY = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "AnimateY");
        ...
        public MMTweenType AnimateRotationTweenZ = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "AnimateZ");
        ...
        /// how the x part of the rotation should animate over time, in degrees
        [Tooltip("how the x part of the rotation should animate over time, in degrees")]
        public MMTweenType ToDestinationTween = new(MMTween.MMTweenCurve.EaseInQuintic, "", "Mode", (int)Modes.ToDestination);
