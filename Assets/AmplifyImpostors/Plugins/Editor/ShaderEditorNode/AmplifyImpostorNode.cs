...
namespace AmplifyShaderEditor
{
    ...
    public sealed class AmplifyImpostorNode : ParentNode
    {
        ...
        private readonly string m_functionHeaderSphereFrag = "SphereImpostorFragment( io, {0}, {1}, {2}, {3} )";
        private readonly string m_functionHeaderSphere = "SphereImpostorVertex( {0}, {1}, {2}, {3}, {4} )";
        private readonly string m_functionHeaderFrag = "OctaImpostorFragment( io, {0}, {1}, {2}, {3}, {4}, {5}, {6} )";
        private readonly string m_functionHeader = "OctaImpostorVertex( {0}, {1}, {2}, {3}, {4}, {5}, {6}, {7} )";
        ...
        private readonly string[] DielecticSRPFix =
        {
        ...
        private readonly Dictionary<string, PropertyEntry> m_propertyNodes = new();
        ...
        private readonly int m_orderBoundsMinProp = 24;
        private readonly int m_orderBoundsSizeProp = 25;

        private static readonly PropertyNames m_albedoTextureNames = new("_Albedo", null, "Albedo (RGB) Alpha (A)");
        private static readonly PropertyNames m_normalTextureNames = new("_Normals", null, "Normals (RGB) Depth (A)");
        private static readonly PropertyNames m_specularTextureNames = new("_Specular", null, "Specular (RGB) Smoothness (A)");
        private static readonly PropertyNames m_occlusionTextureNames = new("_Occlusion", null, "Occlusion (RGB)");
        private static readonly PropertyNames m_emissionTextureNames = new("_Emission", null, "Emission (RGB)");
        private static readonly PropertyNames m_positionTextureNames = new("_Position", null, "Position (RGB)");
        private static readonly PropertyNames m_clipNames = new("_AI_Clip", "_ClipMask", "Clip");
        private static readonly PropertyNames m_textureBiasNames = new("_AI_TextureBias", "_TextureBias", "Texture Bias");
        private static readonly PropertyNames m_useParallaxNames = new("_AI_Use_Parallax", "_Use_Parallax", "Use Parallax");
        private static readonly PropertyNames m_parallaxNames = new("_AI_Parallax", "_Parallax", "Parallax");
        private static readonly PropertyNames m_shadowBiasNames = new("_AI_ShadowBias", null, "Shadow Bias");
        private static readonly PropertyNames m_shadowViewNames = new("_AI_ShadowView", null, "Shadow View");
        private static readonly PropertyNames m_forwardBiasNames = new("_AI_ForwardBias", null, "Forward Bias");
        private static readonly PropertyNames m_hemiNames = new("_AI_Hemi", "_Hemi", "Hemi");
        private static readonly PropertyNames m_useHueNames = new("_AI_Hue", "_Hue", "Use SpeedTree Hue");
        private static readonly PropertyNames m_hueNames = new("_AI_HueVariation", "_HueVariation", "Hue Variation");
        private static readonly PropertyNames m_clipNeighborsNames = new("_AI_ClipNeighborsFrames", "AI_CLIP_NEIGHBOURS_FRAMES", "Clip Neighbours Frames");
        private static readonly PropertyNames m_framesNames = new("_AI_Frames", "_Frames", "Frames");
        private static readonly PropertyNames m_framesXNames = new("_AI_FramesX", "_FramesX", "Frames X");
        private static readonly PropertyNames m_framesYNames = new("_AI_FramesY", "_FramesY", "Frames Y");
        private static readonly PropertyNames m_depthNames = new("_AI_DepthSize", "_DepthSize", "DepthSize");
        private static readonly PropertyNames m_impostorSizeNames = new("_AI_ImpostorSize", "_ImpostorSize", "Impostor Size");
        private static readonly PropertyNames m_offsetNames = new("_AI_Offset", "_Offset", "Offset");
        private static readonly PropertyNames m_sizeOffsetNames = new("_AI_SizeOffset", null, "Size & Offset");
        private static readonly PropertyNames m_boundsMinNames = new("_AI_BoundsMin", null, "Bounds Min");
        private static readonly PropertyNames m_boundsSizeNames = new("_AI_BoundsSize", null, "Bounds Size");
        ...
        private void InitProperty<T>(ref T prop, int order, PropertyNames names, bool hideInInspector = false,
        ...
        private void InitFloatProperty(ref RangedFloatNode prop, int order, PropertyNames names, bool hideInInspector = false, bool toggle = false,
        ...
        private void InitTextureProperty(ref TexturePropertyNode prop, int order, PropertyNames names, TexturePropertyValues value)
        {
        ...
        private void GenerateSphereImpostorVertex(ref MasterNodeDataCollector dataCollector)
        {
            ...
            IOUtils.AddFunctionLine(ref m_functionBody, "frameUVs.zw = sphereLocal.xy * sizeFraction * _Parallax;");
            IOUtils.AddFunctionLine(ref m_functionBody, "#else");
        ...
        private void GenerateSphereImpostorFragment(ref MasterNodeDataCollector dataCollector, bool withSpec = true, bool withOcclusion = true, bool withEmission = true, bool withPosition = false)
        {
            ...
            IOUtils.AddFunctionLine(ref m_functionBody, "float depth = objectNormal.w * " + m_depthProp.PropertyName + " * 0.4999 * length( AI_ObjectToWorld[ 2 ].xyz );");
            IOUtils.AddFunctionLine(ref m_functionBody, "#else");
        ...
        private void GenerateImpostorFragment(ref MasterNodeDataCollector dataCollector, bool withSpec = true, bool withOcclusion = true, bool withEmission = true, bool withPosition = false)
        {
            m_functionBody = string.Empty;
