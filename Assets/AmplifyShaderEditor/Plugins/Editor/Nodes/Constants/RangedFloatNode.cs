...
namespace AmplifyShaderEditor
{
    ...
    public sealed class RangedFloatNode : PropertyNode
    {
        ...
        private readonly string[] m_fieldText = new string[] { "0", "0", "0" };
        ...
        private void DrawFakeFloatMaterial(DrawInfo drawInfo)
        {
            if (m_floatMode)
            {
        ...
        private void DrawFakeSlider(ref float value, DrawInfo drawInfo)
        {
        ...
        private void DrawSlider(ref float value, DrawInfo drawInfo)
        {
            float rangeWidth = 30 * drawInfo.InvertedZoom;
            float rangeSpacing = 5 * drawInfo.InvertedZoom;
