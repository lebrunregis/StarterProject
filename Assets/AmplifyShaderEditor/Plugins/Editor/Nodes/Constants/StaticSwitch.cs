...
namespace AmplifyShaderEditor
{
    ...
    public sealed class StaticSwitch : PropertyNode
    {
        ...
        private readonly float InstanceIconWidth = 19;
        private readonly float InstanceIconHeight = 19;
        private readonly Color ReferenceHeaderColor = new(0f, 0.5f, 0.585f, 1.0f);
        ...
        public override void OnNodeLayout(DrawInfo drawInfo, NodeUpdateCache cache)
        {
            ...
            {
                GUIContent dropdown = new(node.m_inputPorts[CurrentSelectedInput].Name);
        ...
        private void CheckReferenceValues(bool forceUpdate)
        {
            if (m_staticSwitchVarMode == StaticSwitchVariableMode.Reference)
            {
        ...
        private string GetStaticSwitchType(bool allowStages)
        {
        ...
        private void RegisterPragmas(ref MasterNodeDataCollector dataCollector)
        {
            if (CurrentVarMode == StaticSwitchVariableMode.Create)
            {
        ...
        private void SetMaterialToggleRetrocompatibility()
        {
        ...
        private StaticSwitchVariableMode CurrentVarMode
        {
