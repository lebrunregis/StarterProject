...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateInterpData
    {
        ...
        public List<TemplateInterpElement> AvailableInterpolators = new();
        public List<TemplateVertexData> Interpolators = new();
        public List<TemplateVertexData> RawInterpolators = new();
