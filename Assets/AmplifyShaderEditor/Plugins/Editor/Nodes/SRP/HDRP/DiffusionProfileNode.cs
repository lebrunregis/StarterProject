...
namespace AmplifyShaderEditor
{
    ...
    public sealed class DiffusionProfileNode : PropertyNode
    {
        ...
        private readonly bool m_isEditingFields;
        //[NonSerialized]
        ...
        private uint DefaultHash
        { get { return (m_defaultValue != null) ? DiffusionProfileSettingsEx.Hash(m_defaultValue) : 0; } }
        private uint MaterialHash
        { get { return (m_materialValue != null) ? DiffusionProfileSettingsEx.Hash(m_materialValue) : 0; } }
