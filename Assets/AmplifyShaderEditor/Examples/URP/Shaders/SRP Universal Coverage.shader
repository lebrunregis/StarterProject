	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MainTex128 = input.ase_texcoord9.xy;
				float2 uv_Snow600 = input.ase_texcoord9.xy;
				float2 uv_NormalMap132 = input.ase_texcoord9.xy;
				...
				float2 uv_SnowNormal601 = input.ase_texcoord9.xy;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_MainTex128 = input.ase_texcoord4.xy;
				float2 uv_Snow600 = input.ase_texcoord4.xy;
				float2 uv_NormalMap132 = input.ase_texcoord4.xy;
				float3 unpack132 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap132 ), _NormalScale );
				unpack132.z = lerp( 1, unpack132.z, saturate(_NormalScale) );
				float3 tex2DNode132 = unpack132;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_MainTex128 = input.ase_texcoord2.xy;
				float2 uv_Snow600 = input.ase_texcoord2.xy;
				float2 uv_NormalMap132 = input.ase_texcoord2.xy;
				float3 unpack132 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap132 ), _NormalScale );
				unpack132.z = lerp( 1, unpack132.z, saturate(_NormalScale) );
				float3 tex2DNode132 = unpack132;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_NormalMap132 = input.ase_texcoord5.xy;
				float3 unpack132 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap132 ), _NormalScale );
				unpack132.z = lerp( 1, unpack132.z, saturate(_NormalScale) );
				float3 tex2DNode132 = unpack132;
				float2 uv_SnowNormal601 = input.ase_texcoord5.xy;
				float3 unpack601 = UnpackNormalScale( tex2D( _SnowNormal, uv_SnowNormal601 ), _SnowNormalScale );
				unpack601.z = lerp( 1, unpack601.z, saturate(_SnowNormalScale) );
...
Node;AmplifyShaderEditor.SamplerNode;132;256,-448;Inherit;True;Property;_NormalMap;NormalMap;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=4CD844A0AAF98FF56E3804A9D8D27092C1935CDA