...
namespace AseFakeInterior
{
    ...
    public class StartScreen : EditorWindow
    {
        ...
        public static readonly string BannerInfoURL = "https://amplify.pt/Banner/FIInfo.json";
        public static readonly string PackageRefURL = "https://amplify.pt/Banner/PackageRef.json";

        private static readonly string WikiURL = "https://wiki.amplify.pt/index.php?title=Unity_Products:Fake_Interiors";
        ...
        private static readonly GUIContent ResourcesTitle = new("Learning Resources");
        private static readonly GUIContent CommunityTitle = new("Community", "Need help? Reach us through our discord server or the offitial support Unity forum");
        private static readonly GUIContent UpdateTitle = new("Latest News");
        private static readonly GUIContent TitleSTR = new("Fake Interiors");
        ...
        private Texture2D m_newsImage = null;
