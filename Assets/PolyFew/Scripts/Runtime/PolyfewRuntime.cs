...
#pragma warning disable
            ...
            if (runOnThreads)
            {
                ...
                foreach (var kvp in objectMeshPairs)
                {
                    ...
                    var meshSimplifier = new PolyFew.UnityMeshSimplifier.MeshSimplifier();

                    SetParametersForSimplifier(simplificationOptions, meshSimplifier);

                    PolyFew.UnityMeshSimplifier.ToleranceSphere[] tSpheres = new PolyFew.UnityMeshSimplifier.ToleranceSphere[simplificationOptions.preservationSpheres.Count];
                    ...
                    if (!meshRendererPair.attachedToMeshFilter && simplificationOptions.regardPreservationSpheres)
                    {
                        ...
                        foreach (var sphere in simplificationOptions.preservationSpheres)
                        {
                            ...
                            PolyFew.UnityMeshSimplifier.ToleranceSphere toleranceSphere = new PolyFew.UnityMeshSimplifier.ToleranceSphere()
                            {
...
#pragma warning disable
        ...
        private static void SetParametersForSimplifier(SimplificationOptions simplificationOptions, PolyFew.UnityMeshSimplifier.MeshSimplifier meshSimplifier)
        {
