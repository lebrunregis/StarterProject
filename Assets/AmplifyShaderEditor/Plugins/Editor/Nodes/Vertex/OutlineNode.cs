...
namespace AmplifyShaderEditor
{
    ...
    {
        private enum OutlineAlphaModes
        {
            None = 0,
            Masked,
            Transparent,
        ...
        private UpperLeftWidgetHelper m_upperLeftWidget = new();
        ...
        private void CheckAlphaPortVisibility()
        {
        ...
        public override string GenerateShaderForOutput(int outputId, ref MasterNodeDataCollector dataCollector, bool ignoreLocalvar)
        {
            ...
            MasterNodeDataCollector outlineDataCollector = new();
