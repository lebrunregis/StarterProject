...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplatesStencilBufferModule : TemplateModuleParent
    {
        ...
        private Dictionary<string, int> m_comparisonDict = new();
        private Dictionary<string, int> m_stencilOpsDict = new();

        [SerializeField]
        private bool m_active = true;

        private const int ReferenceDefaultValue = 0;
        [SerializeField] private InlineProperty m_reference = new(ReferenceDefaultValue);

        // Read Mask
        private const int ReadMaskDefaultValue = 255;
        [SerializeField] private InlineProperty m_readMask = new(ReadMaskDefaultValue);

        //Write Mask
        private const int WriteMaskDefaultValue = 255;
        [SerializeField] private InlineProperty m_writeMask = new(WriteMaskDefaultValue);

        //Comparison Function
        [NonSerialized] private readonly int ComparisonDefaultValue = 0;
        ...
        //Pass Stencil Op
        [NonSerialized] private readonly int PassStencilOpDefaultValue = 0;
        ...
        //Fail Stencil Op
        [NonSerialized] private readonly int FailStencilOpDefaultValue = 0;
        ...
        //ZFail Stencil Op
        [NonSerialized] private readonly int ZFailStencilOpDefaultValue = 0;
        ...
        private void DrawBlock(UndoParentNode owner, CullMode cullMode)
        {
