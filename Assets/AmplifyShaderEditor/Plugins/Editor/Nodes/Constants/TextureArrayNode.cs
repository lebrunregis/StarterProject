...
namespace AmplifyShaderEditor
{
    ...
    public class TextureArrayNode : PropertyNode
    {
        ...
        private readonly string m_labelText = "None (Texture2DArray)";

        private readonly Color ReferenceHeaderColor = new(2.66f, 1.02f, 0.6f, 1.0f);
        ...
        public override void SetPreviewInputs()
        {
            ...
            {
                if (m_referenceSampler != m_referenceSampler.PreviewTextProp)
                {
        ...
        public override void OnNodeLayout(DrawInfo drawInfo, NodeUpdateCache cache)
        {
            ...
            else if (m_texPort.IsConnected)
            {
                ...
                m_previewTextProp = m_texPort.GetOutputNode(0);
            }
            else
            {
