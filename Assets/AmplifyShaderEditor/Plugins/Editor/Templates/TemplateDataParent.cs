...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateIncludePragmaContainter
    {
        ...
        [SerializeField]
        private List<string> m_nativeDirectivesList = new();

        [SerializeField]
        private List<string> m_includesList = new();
        private Dictionary<string, string> m_includesDict = new();

        [SerializeField]
        private List<string> m_pragmasList = new();
        private Dictionary<string, string> m_pragmasDict = new();

        [SerializeField]
        private List<string> m_definesList = new();
        private Dictionary<string, string> m_definesDict = new();
