...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TessellationOpHelper
    {
        ...
        private readonly GUIContent TessFactorContent = new("Tess", "Tessellation factor\nDefault: 4");
        private readonly GUIContent TessMinDistanceContent = new("Min", "Minimum tessellation distance\nDefault: 10");
        private readonly GUIContent TessMaxDistanceContent = new("Max", "Maximum tessellation distance\nDefault: 25");
        ...
        // Edge Length
        private readonly GUIContent EdgeLengthContent = new("Edge Length", "Tessellation levels ccomputed based on triangle edge length on the screen\nDefault: 4");
        ...
        private readonly GUIContent EdgeLengthTessMaxDisplacementContent = new("Max Disp.", "Max Displacement");

        // Phong
        private readonly GUIContent PhongEnableContent = new("Phong", "Modifies positions of the subdivided faces so that the resulting surface follows the mesh normals a bit\nDefault: OFF");
        private readonly GUIContent PhongStrengthContent = new("Strength", "Strength\nDefault: 0.5");
        ...
        private Dictionary<string, bool> m_additionalDataDict = new();
