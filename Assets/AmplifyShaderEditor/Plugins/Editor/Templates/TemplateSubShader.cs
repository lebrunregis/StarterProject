...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateSubShader
    {
        ...
        [SerializeField]
        private List<TemplatePass> m_passes = new();
        ...
        [SerializeField]
        private TemplateInfoContainer m_LODContainer = new();
        ...
        public TemplateSubShader(TemplateMultiPass template, int subShaderIx, TemplateIdManager idManager, string uniquePrefix, TemplateSubShaderInfo subShaderInfo, ref Dictionary<string, TemplateShaderPropertyData> duplicatesHelper)
        {
            ...
            {
                TemplatePass newPass = new(template, this, subShaderIx, passIdx, idManager, uniquePrefix + "Pass" + passIdx, subShaderInfo.Passes[passIdx].GlobalStartIdx, subShaderInfo.Passes[passIdx], ref ownDuplicatesDict);
        ...
        private void FetchLOD(int offsetIdx, string body)
        {
