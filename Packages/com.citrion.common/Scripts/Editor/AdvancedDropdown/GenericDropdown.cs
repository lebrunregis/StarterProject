...
namespace CitrioN.Common.Editor
{
    public class GenericDropdown<T> : AdvancedDropdown
    {
        ...
        private readonly List<GenericDropdownItemData<T>> data;
        private readonly Action<GenericDropdownItem<T>> onDropdownItemSelected = null;
        ...
        {
            var root = new AdvancedDropdownItem(string.IsNullOrEmpty(displayName) ? string.Empty : displayName);
            AddEntries(root);
            return root;
        }
        ...
        {
            List<AdvancedDropdownItem> dropdownItems = new();
            Dictionary<AdvancedDropdownItem, int> itemOrder = new();
