...
namespace AmplifyShaderEditor
{
    ...
    public class SamplerStateAutoGenerator
    {
        ...
        [SerializeField]
        private InlineSamplerWrapOptions m_mainWrapMode = new();

        [SerializeField]
        private List<InlineSamplerWrapOptions> m_additionalWrapOptions = new();
        ...
        private void DrawAdditionalWrapModes()
        {
        ...
        public void ReadFromString(ref uint index, ref string[] nodeParams)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                InlineSamplerWrapOptions option = new();
