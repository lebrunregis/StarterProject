...
namespace Pinwheel.Griffin.StampTool
{
    ...
    public class GObjectStamperInspector : Editor
    {
        ...
        private class GLayerGUI
        {
            ...
            public static readonly GUIContent INSTANCE_COUNT = new("Instance Count Per Terrain", "Number of instance to spawn on each terrain. Note that final instance count might be different depends on mask intensity");
            ...
            public static readonly GUIContent ALIGN_TO_SURFACE = new("Align To Surface", "Snap the spawned objects to surface normal vector");
            public static readonly GUIContent WORLD_RAYCAST_MASK = new("World Raycast Mask", "Define the layers to perform raycast and snap object position");
        }
        ...
        private class GActionGUI
        {
            ...
            public static readonly GUIContent CLEAR_OBJECT = new("Clear Objects", "Remove all object instances inside the stamper bounding box");
