...
namespace AmplifyShaderEditor
{
    ...
    {
        public static EditorVariableBool LiveMode = new("ASELiveMode", "LiveMode", false);
        public static EditorVariableBool OutlineActiveMode = new("ASEOutlineActiveMode", " Outline", false);
        public static EditorVariableBool NodeParametersMaximized = new("ASENodeParametersVisible", " NodeParameters", true);
        public static EditorVariableBool NodePaletteMaximized = new("ASENodePaletteVisible", " NodePalette", true);
        public static EditorVariableBool ExpandedRenderingPlatforms = new("ASEExpandedRenderingPlatforms", " ExpandedRenderingPlatforms", false);
        public static EditorVariableBool ExpandedRenderingOptions = new("ASEExpandedRenderingOptions", " ExpandedRenderingPlatforms", false);
        public static EditorVariableBool ExpandedGeneralShaderOptions = new("ASEExpandedGeneralShaderOptions", " ExpandedGeneralShaderOptions", false);
        public static EditorVariableBool ExpandedBlendOptions = new("ASEExpandedBlendOptions", " ExpandedBlendOptions", false);
        public static EditorVariableBool ExpandedStencilOptions = new("ASEExpandedStencilOptions", " ExpandedStencilOptions", false);
        public static EditorVariableBool ExpandedVertexOptions = new("ASEExpandedVertexOptions", " ExpandedVertexOptions", false);
        public static EditorVariableBool ExpandedFunctionInputs = new("ASEExpandedFunctionInputs", " ExpandedFunctionInputs", false);
        public static EditorVariableBool ExpandedFunctionSwitches = new("ASEExpandedFunctionSwitches", " ExpandedFunctionSwitches", false);
        public static EditorVariableBool ExpandedFunctionOutputs = new("ASEExpandedFunctionOutputs", " ExpandedFunctionOutputs", false);
        public static EditorVariableBool ExpandedAdditionalIncludes = new("ASEExpandedAdditionalIncludes", " ExpandedAdditionalIncludes", false);
        public static EditorVariableBool ExpandedAdditionalDefines = new("ASEExpandedAdditionalDefines", " ExpandedAdditionalDefines", false);
        public static EditorVariableBool ExpandedAdditionalDirectives = new("ASEExpandedAdditionalDirectives", " ExpandedAdditionalDirectives", false);
        public static EditorVariableBool ExpandedCustomTags = new("ASEExpandedCustomTags", " ExpandedCustomTags", false);
        public static EditorVariableBool ExpandedAdditionalSurfaceOptions = new("ASEExpandedAdditionalSurfaceOptions", " ExpandedAdditionalSurfaceOptions", false);
        public static EditorVariableBool ExpandedAdditionalPragmas = new("ASEExpandedAdditionalPragmas", " ExpandedAdditionalPragmas", false);
        public static EditorVariableBool ExpandedDependencies = new("ASEExpandedDependencies", " ExpandedDependencies", false);
        public static EditorVariableBool ExpandedDepth = new("ASEExpandedDepth", " ExpandedDepth", false);
        public static EditorVariableBool ExpandedTesselation = new("ASEExpandedTesselation", " ExpandedTesselation", false);
        public static EditorVariableBool ExpandedProperties = new("ASEExpandedProperties", " ExpandedProperties", false);
        public static EditorVariableBool ExpandedUsePass = new("ASEUsePass", " UsePass", false);
        //Templates
        public static EditorVariableBool ExpandedBlendModeModule = new("ASEExpandedBlendModeModule", " ExpandedBlendModeModule", false);
    }
