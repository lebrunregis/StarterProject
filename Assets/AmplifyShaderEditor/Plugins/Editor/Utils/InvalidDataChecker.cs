...
namespace AmplifyShaderEditor
{
    ...
    {
        private static readonly string[] m_invalidData = {  "674ea7bed6b1cd94b8057074298096db", //"/Samples",
        ...
        private static readonly string m_invalidDataCollected = string.Empty;
    ...
    {
        private readonly GUIContent m_buttonContent = new("Remove Invalid Data");
