...
namespace AmplifyShaderEditor
{
    ...
    public class ToolbarMenuTab
    {
        ...
        private readonly GenericMenu m_tabMenu;
    ...
    {
        private static readonly Color RightIconsColorOff = new(1f, 1f, 1f, 0.8f);
        private static readonly Color LeftIconsColorOff = new(1f, 1f, 1f, 0.5f);

        private static readonly Color RightIconsColorOn = new(1f, 1f, 1f, 1.0f);
        private static readonly Color LeftIconsColorOn = new(1f, 1f, 1f, 0.8f);
        ...
        private Rect m_areaLeft = new(0, 0, 140, 40);
        private Rect m_areaRight = new(0, 0, 75, 40);
        ...
        private List<ParentNode> m_searchResultNodes = new();
        ...
        private void OnButtonPressedEvent(ToolButtonType type)
        {
        ...
        private int m_previousNodeCount = 0;
