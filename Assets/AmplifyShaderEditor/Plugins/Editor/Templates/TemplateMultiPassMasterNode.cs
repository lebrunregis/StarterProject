...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateMultiPassMasterNode : MasterNode
    {
        ...
        private static readonly int PASS_SELECTOR_VERSION = 16200;
        private static readonly int PASS_UNIQUE_ID_VERSION = 16204;
        ...
        [SerializeField]
        private TemplateModulesHelper m_subShaderModule = new();

        [SerializeField]
        private TemplateModulesHelper m_passModule = new();
        ...
        [SerializeField]
        private TemplateOptionsUIHelper m_subShaderOptions = new(true);

        [SerializeField]
        private TemplateOptionsUIHelper m_passOptions = new(false);

        [SerializeField]
        private TemplatePassSelectorHelper m_passSelector = new();

        [SerializeField]
        private TemplateOptionsDefinesContainer m_optionsDefineContainer = new();
        ...
        private void SetupCustomOptionsFromTemplate(bool newTemplate)
        {
        ...
        private void SetPassCustomOptionsInfo(TemplateMultiPassMasterNode masterNode)
        {
        ...
        private void RefreshCustomOptionsDict()
        {
        ...
        private void SetCategoryIdxFromTemplate()
        {
        ...
        private void DrawOpenTemplateButton()
        {
        ...
        private void SetExtraDefine(string define)
        {
        ...
        private void DrawLODAddRemoveButtons()
        {
            DrawLODAddRemoveButtons(-2, true);
        }

        private void DrawLODAddRemoveButtons(int index, bool showRemove)
        {
        ...
        private void DrawPassProperties()
        {
            EditorGUI.BeginChangeCheck();
        ...
        private bool CreateInstructionsForList(TemplateData templateData, ref List<InputPort> ports, ref string shaderBody, ref List<string> vertexInstructions, ref List<string> fragmentInstructions)
        {
            if (ports.Count == 0)
                return true;
            AddHDKeywords();
        ...
        {
            ForceReordering();
            MasterNodeDataCollector overallDataCollector = new();
            ...
            MasterNodeDataCollector dummy = new();
        ...
        public void CollectData()
        {
            ...
            //Sort ports by both
            List<InputPort> fragmentPorts = new();
            List<InputPort> vertexPorts = new();
            ...
            List<string> vertexInstructions = new();
            List<string> fragmentInstructions = new();
        ...
        public void FillPassData(TemplateMultiPassMasterNode masterNode, TemplateDataCollector mainTemplateDataCollector)
        {
            ...
            if (m_currentDataCollector != null)
            {
                ...
                List<PropertyDataCollector> afterNativesIncludePragmaDefineList = new();
                ...
                List<PropertyDataCollector> beforeNatives = new();
        ...
        {
            List<PropertyDataCollector> newItems = new();
        ...
        private void SetLinkedModuleData(TemplateModulesHelper linkedModule)
        {
        ...
        private void SetModuleData(TemplateModulesHelper module, bool isSubShader)
        {
            if (isSubShader)
            {
            ...
            else
            {
                ...
                //}
                List<PropertyDataCollector> aboveUsePass = new();
                List<PropertyDataCollector> belowUsePass = new();
        ...
        private void UpdateSubShaderPassStr()
        {
        ...
        private void CheckLegacyCustomInspectors()
        {
