...
namespace MoreMountains.Tools
{
    public class MMSMPlaylistManager : MMMonoBehaviour
    {
        ...
        public MMTweenType FadeTween = new(MMTween.MMTweenCurve.EaseInCubic);
        ...
        public Vector2 TimescaleRemapFrom = new(0f, 2f);
        ...
        [MMCondition("BindPitchToTimeScale", true)]
        public Vector2 TimescaleRemapTo = new(0.8f, 1.2f);
