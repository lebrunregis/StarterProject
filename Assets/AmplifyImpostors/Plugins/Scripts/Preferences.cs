...
namespace AmplifyImpostors
{
    public class Preferences
    {
        ...
        private static readonly GUIContent StartUp = new("Show start screen on Unity launch", "You can set if you want to see the start screen everytime Unity launches, only just when there's a new version available or never.");
        private static readonly GUIContent AutoSRP = new("Auto import SRP shaders", "By default Amplify Impostors checks for your SRP version and automatically imports compatible shaders.\nTurn this OFF if you prefer to import them manually.");
        ...
        public static string GlobalNormals = EditorPrefs.GetString(PrefGlobalGBuffer1Name, DefaultSpecularName);
        public static string GlobalSpecular = EditorPrefs.GetString(PrefGlobalGBuffer2Name, DefaultNormalName);
        ...
        private static readonly GUIContent DefaultSuffixesLabel = new("Default Suffixes", "Default Suffixes for new Bake Presets");

        private static bool PrefsLoaded = false;
        private static readonly GUIContent PathButtonContent = new();
