...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_PositionSpring : MMF_Feedback
    {
        ...
        public Vector3 MoveToPositionMin = new(1f, 1f, 1f);
        ...
        [MMFEnumCondition("Mode", (int)Modes.MoveTo, (int)Modes.MoveToAdditive)]
        public Vector3 MoveToPositionMax = new(2f, 2f, 2f);
        ...
        public Vector3 BumpPositionMin = new(0f, 20f, 0f);
        ...
        [MMFEnumCondition("Mode", (int)Modes.Bump)]
        public Vector3 BumpPositionMax = new(0f, 30f, 0f);
