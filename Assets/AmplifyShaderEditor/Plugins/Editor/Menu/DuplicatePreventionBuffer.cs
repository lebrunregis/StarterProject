...
namespace AmplifyShaderEditor
{
    ...
    public class DuplicatePreventionBuffer
    {
        ...
        private readonly string[] m_availableUVChannelsNamesArray = { "null",
                                                            "null",
                                                            "null",
                                                            "null" };

        private readonly Dictionary<string, int> m_availablePropertyNames = new();
        private readonly Dictionary<string, int> m_availableUniformNames = new();
        private readonly Dictionary<string, int> m_availableLocalVariableNames = new();
