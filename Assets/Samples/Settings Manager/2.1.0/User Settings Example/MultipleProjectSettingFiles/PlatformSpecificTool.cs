...
namespace UnityEditor.SettingsManagement.Examples
{
    ...
    internal class PerPlatformSettingsTool : EditorTool
    {
        ...
        private static readonly string[] k_ProjectRepositories = new[]
        {
            "Settings A",
            "Settings B"
        };
        ...
        private const string k_ToolColorSetting = "ToolColor";
        ...
        private Vector3 m_HandlePosition;
        ...
        private Color GetToolColor(string repository, Color defaultColor)
        {
