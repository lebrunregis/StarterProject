...
namespace AmplifyImpostors
{
    ...
    public class AIStartScreen : EditorWindow
    {
        ...
        private static readonly GUIContent SamplesTitle = new("Samples", "Import samples according to you project rendering pipeline");
        private static readonly GUIContent ResourcesTitle = new("Learning Resources", "Check the online wiki for various topics about how to use AI with node examples and explanations");
        private static readonly GUIContent CommunityTitle = new("Community", "Need help? Reach us through our discord server or the official support Unity forum");
        private static readonly GUIContent UpdateTitle = new("Latest Update", "Check the lastest additions, improvements and bug fixes done to AI");
        private static readonly GUIContent AITitle = new("Amplify Impostors", "Are you using the latest version? Now you know");
        ...
        private Preferences.ShowOption m_startup = Preferences.ShowOption.Never;

        [NonSerialized]
        private Texture packageIcon = null;
        [NonSerialized]
        private Texture textIcon = null;
        [NonSerialized]
        private Texture webIcon = null;

        private GUIContent HDRPbutton = null;
        private GUIContent URPbutton = null;
        private GUIContent BuiltInbutton = null;

        private GUIContent Manualbutton = null;

        private GUIContent DiscordButton = null;
        private GUIContent ForumButton = null;

        private GUIContent AIIcon = null;
        ...
        private static readonly Dictionary<int, AISRPPackageDesc> m_srpSamplePackages = new()
        {
            ...
            { ( int )AISRPBaseline.AI_SRP_15, new AISRPPackageDesc( AISRPBaseline.AI_SRP_15, "49ea3764a534e4347848722ad53b9bf1", "0fd95d7c6a1a1864eb85fef533f5e5df" ) },
            { ( int )AISRPBaseline.AI_SRP_16, new AISRPPackageDesc( AISRPBaseline.AI_SRP_16, "349761993cf8d6a41970c379725073d4", "f61a93a0b64d3dd499926d4ad5816cb1" ) },
        ...
        private void ImportSample(string pipeline, TemplateSRPType srpType)
        {
        ...
        private IEnumerator StartRequest(string url, Action success = null)
        {
    ...
    public static class ShowStartScreen
    {
        ...
        private static IEnumerator StartRequest(string url, Action success = null)
        {
            using (www = UnityWebRequest.Get(url))
            {
                yield return www.SendWebRequest();
