...
namespace CitrioN.Common.Editor
{
    ...
    {
        public static Dictionary<string, ReorderableList> propertyLists = new();

        public static Dictionary<IList, ReorderableList> ilists = new();

        public static Dictionary<ReorderableList, int> selectedElements = new();
