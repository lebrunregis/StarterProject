...
namespace CitrioN.Common.Editor
{
    public class UnityPackagesList : ListFromScriptableObjectItemDataCreator<ScriptableObjectItemData_PackageRemoval>
    {
        ...
        protected List<ScriptableObjectItemData_PackageRemoval> packageDatas = new();

        protected static List<string> packagesToRemove = new();
      ...
      return;
            ...
            List<string> dependentPackages = new();

            if (/*includeDependencies*/true)
            {
                Dictionary<string, DependencyInfo[]> dependenciesDictionary = new();
                ...
                List<string> packagesNotToRemove = new();
