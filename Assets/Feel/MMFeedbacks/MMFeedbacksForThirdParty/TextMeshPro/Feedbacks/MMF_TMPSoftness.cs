...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_TMPSoftness : MMF_Feedback
    {
        ...
        public MMTweenType SoftnessCurve = new(new AnimationCurve(new Keyframe(0, 0f), new Keyframe(0.3f, 1f), new Keyframe(1, 0f)), "", "Mode", (int)MMFeedbackBase.Modes.OverTime);
