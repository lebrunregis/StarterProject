...
namespace AmplifyShaderEditor
{
    ...
    public class ASESaveBundleAssetEditor : Editor
    {
        ...
        private readonly GUIContent m_packageContentsOriginLabel = new("Search Path");

        private SerializedProperty m_allExtras;

        private SerializedProperty m_packageTargetPath;
        private readonly GUIContent m_packageTargetPathLabel = new("Package Path");

        private SerializedProperty m_packageTargetName;
        private readonly GUIContent m_packageTargetNameLabel = new("Package Name");
        ...
        public void OnEnable()
        {
            ...
            if (m_listExtras == null)
            {
                ...
                {
                    rect.width -= 55;
                    m_allExtras.GetArrayElementAtIndex(index).stringValue = EditorGUI.TextField(rect, "Path " + index, m_allExtras.GetArrayElementAtIndex(index).stringValue);
        ...
        private void FetchValidShadersFromPath(string path, bool updateProperty)
        {
    ...
    public class ASESaveBundleTool : EditorWindow
    {
        ...
        private ASESaveBundleAssetEditor m_editor;
