...
namespace AmplifyShaderEditor
{
    ...
    internal class MaterialInspector : ShaderGUI
    {
        ...
        private Vector2 m_previewDir = new(120f, -20f);
        ...
        private object m_previewSettingsInstance;
        private FieldInfo previewDirInfo;
        private FieldInfo shadedMaterialInfo;
        private FieldInfo activeMaterialInfo;
#endif
        ...
        private static void EnsureKeywordState(Material mat, string keyword, bool state)
        {
