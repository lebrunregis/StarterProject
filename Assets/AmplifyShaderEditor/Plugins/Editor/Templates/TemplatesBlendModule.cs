...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplatesBlendModule : TemplateModuleParent
    {
        ...
        private readonly string[] m_commonBlendTypesArr;
        private readonly List<CommonBlendTypes> m_commonBlendTypes = new()
        {
        ...
        [SerializeField]
        private InlineProperty m_sourceFactorRGBInline = new();

        [SerializeField]
        private AvailableBlendFactor m_destFactorRGB = AvailableBlendFactor.Zero;
        [SerializeField]
        private InlineProperty m_destFactorRGBInline = new();
        ...
        [SerializeField]
        private InlineProperty m_sourceFactorAlphaInline = new();

        [SerializeField]
        private AvailableBlendFactor m_destFactorAlpha = AvailableBlendFactor.Zero;
        [SerializeField]
        private InlineProperty m_destFactorAlphaInline = new();
        ...
        [SerializeField]
        private InlineProperty m_blendOpRGBInline = new();

        [SerializeField]
        private AvailableBlendOps m_blendOpAlpha = AvailableBlendOps.OFF;

        [SerializeField]
        private InlineProperty m_blendOpAlphaInline = new();
        ...
        private void DrawBlock(UndoParentNode owner, bool style)
        {
