...
namespace AmplifyShaderEditor
{
    ...
    {
        private readonly string[] m_sizesStr = { "32", "64", "128", "256", "512", "1024", "2048", "4096", "8192" };
        ...
        private readonly GUIContent m_pathButtonContent = new();
        ...
        private SerializedProperty m_selectedSize;
        private SerializedProperty m_lockRatio;
        private SerializedProperty m_sizeX;
        private SerializedProperty m_sizeY;
        private SerializedProperty m_tex3DMode;
        private SerializedProperty m_linearMode;
        private SerializedProperty m_mipMaps;
        private SerializedProperty m_wrapMode;
        private SerializedProperty m_filterMode;
        private SerializedProperty m_anisoLevel;
        private SerializedProperty m_selectedFormatEnum;
        private SerializedProperty m_quality;
        private SerializedProperty m_folderPath;
        private SerializedProperty m_fileName;
        private SerializedProperty m_filenameChanged;
        private SerializedProperty m_allTextures;
        ...
        public void OnEnable()
        {
            ...
            if (m_listTextures == null)
            {
                ...
                m_listTextures.drawHeaderCallback = (Rect rect) =>
                {
                    ...
                    if (m_previewSize != m_listTextures.elementHeight)
    ...
    public class ASETextureArrayCreator : EditorWindow
    {
        ...
        private TextureArrayCreatorAssetEditor m_editor;
        ...
        private static readonly List<TextureFormat> UncompressedFormats = new()
        {
        ...
        private void BuildTexture3D(TextureArrayCreatorAsset asset)
        {
            ...
            Texture3D texture3D = new(sizeX, sizeY, asset.AllTextures.Count, asset.SelectedFormatEnum, asset.MipMaps);
            texture3D.wrapMode = asset.WrapMode;
            texture3D.filterMode = asset.FilterMode;
            texture3D.anisoLevel = asset.AnisoLevel;
            texture3D.Apply(false);
            RenderTexture cache = RenderTexture.active;
            RenderTexture rt = new(sizeX, sizeY, 0, RenderTextureFormat.ARGBFloat, RenderTextureReadWrite.Default);
            rt.Create();
            List<List<Color>> mipColor = new();
            if (asset.MipMaps)
            {
            ...
            for (int i = 0; i < asset.AllTextures.Count; i++)
            {
                ...
                Texture2D t2d = new(sizeX, sizeY, validReadPixelsFormat, asset.MipMaps, asset.LinearMode);
        ...
        private void BuildArray(TextureArrayCreatorAsset asset)
        {
            ...
            Texture2DArray textureArray = new(sizeX, sizeY, asset.AllTextures.Count, asset.SelectedFormatEnum, asset.MipMaps, asset.LinearMode);
