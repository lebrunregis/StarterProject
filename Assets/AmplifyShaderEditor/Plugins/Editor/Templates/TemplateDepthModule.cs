...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateDepthModule : TemplateModuleParent
    {
        ...
        [SerializeField]
        private InlineProperty m_zTestMode = new(0);

        [SerializeField]
        private bool m_validZWrite = false;

        [SerializeField]
        private InlineProperty m_zWriteMode = new(0);

        [SerializeField]
        private InlineProperty m_offsetFactor = new(0);

        [SerializeField]
        private InlineProperty m_offsetUnits = new(0);
        ...
        private void DrawBlock(UndoParentNode owner)
        {
