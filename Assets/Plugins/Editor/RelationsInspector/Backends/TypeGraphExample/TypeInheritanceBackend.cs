...
namespace RelationsInspector.Backend.TypeHierarchy
{
    ...
    {
        private static bool includeInterfaces = false;
        ...
        private readonly HashSet<Type> targetTypes = new();
        private readonly HashSet<Type> parentTypes = new();
        ...
        private IEnumerable<Relation<Type, TypeRelation>> GetRelated(Type entity)
        {
        ...
        private IEnumerable<Relation<Type, TypeRelation>> GetRelating(Type entity)
        {
        ...
        private static Relation<Type, TypeRelation> GetRelation(Type sourceType, Type targetType)
        {
