...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_RotationSpring : MMF_Feedback
    {
        ...
        public Vector3 MoveToRotationMin = new(45f, 0f, 0f);
        ...
        [MMFEnumCondition("Mode", (int)Modes.MoveTo, (int)Modes.MoveToAdditive)]
        public Vector3 MoveToRotationMax = new(90f, 0f, 0f);
        ...
        public Vector3 BumpRotationMin = new(2000f, 2000f, 0f);
        ...
        [MMFEnumCondition("Mode", (int)Modes.Bump)]
        public Vector3 BumpRotationMax = new(3000f, 3000f, 0f);
