...
namespace AmplifyShaderEditor
{
    ...
    {
        private static readonly Color OverallColorOn = new(1f, 1f, 1f, 0.9f);
        private static readonly Color OverallColorOff = new(1f, 1f, 1f, 0.3f);
        private static readonly Color FontColorOff = new(1f, 1f, 1f, 0.4f);
        ...
        private GUIContent m_leftAuxContent = new();
        private GUIContent m_rightAuxContent = new();
