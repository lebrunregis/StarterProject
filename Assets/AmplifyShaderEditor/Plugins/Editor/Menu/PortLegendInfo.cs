...
{
    internal class NodeDescriptionInfo
    {
    ...
    public sealed class PortLegendInfo : EditorWindow
    {
        ...
        private readonly GUIContent m_content = new("Helper", "Shows helper info for ASE users");
        ...
        private void DrawPort(WirePortDataType type)
        {
        ...
        private void DrawItem(string name, string description)
        {
        ...
        private string CreateCompatibilityString(string source)
        {
            ...
            if (window != null)
            {
                if (m_nodeDescriptionsInfo == null)
                {
                    ...
                    while (enumerator.MoveNext())
                    {
                        ...
                        NodeDescriptionInfo currInfo = new();
