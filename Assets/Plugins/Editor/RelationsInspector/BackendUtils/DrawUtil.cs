...
namespace RelationsInspector.Backend
{
    public static class DrawUtil
    {
        ...
        public static Vector2 boxIconSize = new(16, 16);
        private static Vector2 shadowOffset = new(2, 2);
        ...
        private static void DrawSquareTexture(Vector2 center, float width, Color color, Texture2D texture)
        {
