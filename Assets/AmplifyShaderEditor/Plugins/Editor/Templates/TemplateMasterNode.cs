...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateMasterNode : MasterNode
    {
        ...
        private void FetchInfoFromTemplate()
        {
        ...
        private void FetchCurrentTemplate()
        {
        ...
        private bool CreateInstructionsForList(ref List<InputPort> ports, ref string shaderBody, ref List<string> vertexInstructions, ref List<string> fragmentInstructions)
        {
            if (ports.Count == 0)
                return true;
