...
namespace sc.modeling.splines.runtime
{
    public partial class SplineMesher
    {
        ...
        public List<SplineData<VertexColorChannel>> vertexColorRedData = new();
        public List<SplineData<VertexColorChannel>> vertexColorGreenData = new();
        public List<SplineData<VertexColorChannel>> vertexColorBlueData = new();
        public List<SplineData<VertexColorChannel>> vertexColorAlphaData = new();
        ...
        public static Float3Interpolator scaleInterpolator = new();
        ...
        private void ValidateVertexColorData(ref List<SplineData<VertexColorChannel>> channel)
        {
            ...
            for (var i = 0; i < delta; i++)
            {
                ...
                SplineData<VertexColorChannel> data = new();

                VertexColorChannel dataPoint = new();
                dataPoint.value = 0f;
