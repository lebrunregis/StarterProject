...
namespace AmplifyShaderEditor
{
    ...
    internal class CustomShaderInspector : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent showCurrent = new("Compile and show code | ▾");
        ...
        private const float kValueFieldWidth = 200.0f;
        private const float kArrayValuePopupBtnWidth = 25.0f;
        ...
        private static readonly int m_sliderHashCode = -1;
                ...
                case EventType.MouseDrag:
                    {
                        if (GUIUtility.hotControl == controlID)
                        {
                            scrollPosition -= DeltaMultiplier * current.delta * ((current.shift) ? ShiftMouseSpeed : DefaultMouseSpeed) / Mathf.Min(position.width, position.height);
        ...
        internal static void ShaderErrorListUI(UnityEngine.Object shader, ShaderError[] errors, ref Vector2 scrollPosition)
        {
            ...
            float minHeight = Mathf.Min(num * 20f + 40f, 150f);
        ...
        private ShaderMessage[] m_ShaderMessages;
        ...
        private void ShowCompiledCodeButton(Shader s)
        {
            ...
            if (hasCode)
            {
                ...
                Rect position = new(rect.xMax - 16f, rect.y, 16f, rect.height);
    ...
    internal class KeywordsPopup : PopupWindowContent
    {
        ...
        private readonly string[] m_GlobalKeywords;
        private readonly string[] m_LocalKeywords;
