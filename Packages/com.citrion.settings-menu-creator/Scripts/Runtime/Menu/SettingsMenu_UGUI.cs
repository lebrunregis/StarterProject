...
namespace CitrioN.SettingsMenuCreator
{
    ...
    public class SettingsMenu_UGUI : CanvasUIPanel
    {
        ...
        private List<RectTransform> inputElements = new();

        protected Dictionary<RectTransform, SettingHolder> settingObjects = new();

        protected Dictionary<RectTransform, bool> inputElementWasGenerated = new();
      ...
      if (qualityLevelCoroutine != null)
      {
        ...
        protected void UpdateSettingsFields(bool initialize)
        {
            if (Root != null && runtimeSettings != null)
            {
                ...
                Dictionary<string, List<string>> parentChildrenMapping = new();
        ...
        {
            List<RectTransform> elementsToRemove = new();
