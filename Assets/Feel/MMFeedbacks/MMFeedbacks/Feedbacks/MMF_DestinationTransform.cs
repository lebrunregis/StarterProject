...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_DestinationTransform : MMF_Feedback
    {
        ...
        public MMTweenType AnimatePositionTween = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "SeparatePositionCurve");
        ...
        public MMTweenType AnimateRotationTween = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "SeparateRotationCurve");
        ...
        public MMTweenType AnimateScaleTween = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "SeparateScaleCurve");
