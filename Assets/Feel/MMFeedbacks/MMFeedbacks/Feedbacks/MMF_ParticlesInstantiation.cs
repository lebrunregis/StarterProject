...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_ParticlesInstantiation : MMF_Feedback
    {
        ...
        public List<int> RandomParticleWeights = new();
        ...
        protected virtual void CreatePools(MMF_Player owner)
        {
            ...
            if (!_poolCreatedOrFound)
            {
                ...
                if (RandomParticlePrefabs.Count > 0)
                {
                    ...
                    {
                        GameObject randomObjectPoolGo = new();
        ...
        protected virtual void InstantiateParticleSystem()
        {
            ...
            if (RandomParticlePrefabs.Count > 0)
            {
                if (ShouldCache)
                {
                    ...
                    {
                        ParticleSystem newSystem = GameObject.Instantiate(system, newParent);
                        if (newParent == null)
                        {
                ...
                else
                {
                    ...
                    _instantiatedParticleSystem = GameObject.Instantiate(RandomParticlePrefabs[random], newParent);
                    if (newParent == null)
                    {
            ...
            else
            {
                ...
                _instantiatedParticleSystem = GameObject.Instantiate(ParticlesPrefab, newParent);
