...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateShaderPropertyNode : TemplateNodeParent
    {
        ...
        private UpperLeftWidgetHelper m_upperLeftWidgetHelper = new();
        ...
        private void FetchShaderProperties()
        {
        ...
        private void DrawMultipassProperties()
        {
            EditorGUI.BeginChangeCheck();
        ...
        private string GenerateTitle(params float[] values)
        {
            //string finalResult = "( ";
        ...
        private bool SetTemplate(MasterNode newMasterNode)
        {
