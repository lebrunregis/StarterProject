...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TransformPositionNode : ParentNode
    {
        ...
        private readonly string InverseTBNStr = "Inverse TBN";
        ...
        private void CalculateTransform(TransformSpaceFrom from, TransformSpaceTo to, ref MasterNodeDataCollector dataCollector, ref string varName, ref string result)
        {
            switch (from)
            {
