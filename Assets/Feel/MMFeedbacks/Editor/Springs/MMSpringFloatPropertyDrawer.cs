...
namespace MoreMountains.Feedbacks
{
    ...
    internal class MMSpringFloatPropertyDrawer : PropertyDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            if (Application.isPlaying && !_unifiedSpring.boolValue)
            {
                ...
                FloatField currentValue = new("CurrentValue") { bindingPath = "CurrentValueDisplay", isReadOnly = true, style = { flexGrow = 1, paddingRight = 10 } };
                currentValue.SetEnabled(false);
                currentValue.AddToClassList("mm-fixed-width-floatfield");
                horizontalLayout.Add(currentValue);

                FloatField targetValue = new("TargetValue") { bindingPath = "TargetValueDisplay", isReadOnly = true, style = { flexGrow = 1 } };
                targetValue.SetEnabled(false);
                targetValue.AddToClassList("mm-fixed-width-floatfield");
                horizontalLayout.Add(targetValue);

                FloatField velocity = new("Velocity") { bindingPath = "VelocityDisplay", isReadOnly = true, style = { flexGrow = 1, paddingLeft = 10 } };
