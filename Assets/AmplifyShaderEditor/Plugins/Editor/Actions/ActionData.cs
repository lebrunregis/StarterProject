...
namespace AmplifyShaderEditor
{
    ...
    public class CreateNodeActionData : ActionData
    {
        ...
        private readonly System.Type m_nodeType;
    ...
    {
        private readonly int m_inputNodeId;
        private readonly int m_inputPortId;

        private readonly int m_outputNodeId;
        private readonly int m_outputPortId;
    ...
    {
        private readonly int m_oldInputNodeId;
        private readonly int m_oldInputNodePortId;

        private readonly int m_newInputNodeId;
        private readonly int m_newInputNodePortId;
    ...
    public class MoveOutputConnectionActionData : ActionData
    {
        ...
        private readonly int m_newOutputNodeId;
        private readonly int m_newOutputPortId;

        private readonly int m_oldOutputNodeId;
        private readonly int m_oldOutputPortId;
    ...
    {
        private readonly string m_originalProperties;
        private readonly string m_newProperties;
        private readonly int m_nodeId;
