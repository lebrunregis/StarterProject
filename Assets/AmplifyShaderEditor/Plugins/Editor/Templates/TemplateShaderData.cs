...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateSubShaderInfo
    {
        ...
        public List<TemplatePassInfo> Passes = new();
        public void Destroy()
        {
            Passes.Clear();
            Passes = null;
    ...
    public class TemplateShaderInfo
    {
        ...
        public List<TemplateSubShaderInfo> SubShaders = new();
        public void Destroy()
        {
        ...
        public static TemplateShaderInfo CreateShaderData(string body)
        {
            ...
            if (shaderMatch.Count > 0)
            {
                ...
                if (subShaderAmount > 0)
                {
                    ...
                    {
                        TemplateSubShaderInfo subShaderData = new();
