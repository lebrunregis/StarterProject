...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_MMSoundManagerSound : MMF_Feedback
    {
        ...
        public MMTweenType FadeTween = new(MMTween.MMTweenCurve.EaseInOutQuartic, "Fade");
        ...
        [MMVector("Min", "Max")]
        public Vector2 PlaybackDuration = new(0f, 0f);
        ...
        public override void AutomaticShakerSetup()
        {
            ...
            {
                GameObject soundManagerGo = new("MMSoundManager");
