...
namespace AmplifyShaderEditor
{
    ...
    public struct Constants
    {
        ...
        public readonly static List<string> UnityNativeInspectors = new()
        {
        ...
        public readonly static Dictionary<string, string> CustomInspectorHD7To10 = new()
        {
        ...
        public readonly static Dictionary<string, string> CustomInspectorURP10To12 = new()
        {
            { "UnityEditor.ShaderGraph.PBRMasterGUI","UnityEditor.ShaderGraphLitGUI"},
        };

        public readonly static Dictionary<string, string> CustomInspectorHDLegacyTo11 = new()
        {
        ...
        public readonly static Dictionary<TextureType, string> TexDeclarationSRPMacros = new()
        {
        ...
        public readonly static Dictionary<TextureType, string> SamplerDeclarationSRPMacros = new()
        {
        ...
        public readonly static Dictionary<TextureType, string> TexDeclarationNoSamplerSRPMacros = new()
        {
        ...
        public readonly static Dictionary<TextureType, string> TexSampleSRPMacros = new()
        {
        ...
        public readonly static Dictionary<TextureType, string> TexParams = new()
        {
        ...
        public readonly static Dictionary<WirePortDataType, TextureType> WireToTexture = new()
        {
        ...
        public readonly static Dictionary<TextureType, WirePortDataType> TextureToWire = new()
        {
        ...
        public readonly static Dictionary<TextureType, string> TexDeclarationStandardMacros = new()
        {
        ...
        public readonly static Dictionary<TextureType, string> TexDeclarationNoSamplerStandardMacros = new()
        {
        ...
        public readonly static Dictionary<TextureType, string> TexSampleStandardMacros = new()
        {
        ...
        public readonly static Dictionary<TextureType, string> TexSampleSamplerStandardMacros = new()
        {
            { TextureType.Texture2D,"SAMPLE_TEXTURE2D{0}( {1}, {2}, {3} )"},
            { TextureType.Texture3D,"SAMPLE_TEXTURE3D{0}( {1}, {2}, {3} )"},
            { TextureType.Cube,"SAMPLE_TEXTURECUBE{0}( {1}, {2}, {3} )"},
        ...
        public readonly static Dictionary<TextureType, string> TexSampleStandard = new()
        {
        ...
        public readonly static Color DefaultCategoryColor = new(0.26f, 0.35f, 0.44f, 1.0f);
        public readonly static Color NodeBodyColor = new(1f, 1f, 1f, 1.0f);

        public readonly static Color ModeTextColor = new(1f, 1f, 1f, 0.25f);
        public readonly static Color ModeIconColor = new(1f, 1f, 1f, 0.75f);

        public readonly static Color PortTextColor = new(1f, 1f, 1f, 0.5f);
        public readonly static Color PortLockedTextColor = new(1f, 1f, 1f, 0.35f);
        public readonly static Color BoxSelectionColor = new(0.5f, 0.75f, 1f, 0.33f);
        public readonly static Color SpecialRegisterLocalVarSelectionColor = new(0.27f, 0.52f, 1.0f, 1f);
        public readonly static Color SpecialGetLocalVarSelectionColor = new(0.2f, 0.8f, 0.4f, 1f);
        public readonly static Color NodeSelectedColor = new(0.85f, 0.56f, 0f, 1f);
        public readonly static Color NodeDefaultColor = new(1f, 1f, 1f, 1f);
        public readonly static Color NodeConnectedColor = new(1.0f, 1f, 0.0f, 1f);
        public readonly static Color NodeErrorColor = new(1f, 0.5f, 0.5f, 1f);
        ...
        public readonly static GUIContent DefaultValueLabelContent = new("Default Value");
        public readonly static GUIContent MaterialValueLabelContent = new("Material Value");
        ...
        public readonly static string IsFrontFaceInputVFACE = "half ASEIsFrontFace : VFACE";
        ...
        public readonly static Color LockedPortColor = new(0.3f, 0.3f, 0.3f, 0.5f);
        ...
        public readonly static Vector2 CopyPasteDeltaPos = new(40, 40);
