...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Position : MMF_Feedback
    {
        ...
        public MMTweenType AnimatePositionTween = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(1, 1)), "", "Mode", (int)Modes.AtoB, (int)Modes.ToDestination);
        ...
        public MMTweenType AnimatePositionTweenX = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(0.6f, -1f), new Keyframe(1, 0f)), "AnimateX");
        ...
        /// the acceleration of the movement
        [Tooltip("the acceleration of the movement")]
        public MMTweenType AnimatePositionTweenY = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(0.6f, -1f), new Keyframe(1, 0f)), "AnimateY");
        ...
        /// the acceleration of the movement
        [Tooltip("the acceleration of the movement")]
        public MMTweenType AnimatePositionTweenZ = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(0.6f, -1f), new Keyframe(1, 0f)), "AnimateZ");
