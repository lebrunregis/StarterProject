...
namespace SBG.Toolbelt
{
    ...
    public static class THelper
    {
        ...
        /// </summary>
        public static Vector2 AddToVector(Vector2 a, float b) => new(a.x + b, a.y + b);
        /// <summary>
        /// Adds a float to every dimension of the vector
        /// </summary>
        public static Vector3 AddToVector(Vector3 a, float b) => new(a.x + b, a.y + b, a.z + b);
        /// <summary>
