...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateDataCollector
    {
        ...
        private readonly int[] m_UVUsage = { 0, 0, 0, 0, 0, 0, 0, 0 };
        ...
        private List<PropertyDataCollector> m_lateDirectivesList = new();
        private Dictionary<string, PropertyDataCollector> m_lateDirectivesDict = new();

        private List<PropertyDataCollector> m_srpBatcherPropertiesList = new();
        private List<PropertyDataCollector> m_fullSrpBatcherPropertiesList = new();
        private Dictionary<string, PropertyDataCollector> m_srpBatcherPropertiesDict = new();
        ...
        public void AddSRPBatcherProperty(int nodeID, string property)
        {
            ...
            {
                PropertyDataCollector newValue = new(nodeID, property);
        ...
        public void AddLateDirective(AdditionalLineType type, string value)
        {
            ...
            if (!m_lateDirectivesDict.ContainsKey(value))
            {
                ...
                PropertyDataCollector property = new(-1, formattedValue);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////
        private bool IsSemanticUsedOnInterpolator(TemplateSemantics semantics)
        {
        ...
        private TemplateVertexData RegisterOnInterpolator(TemplateSemantics semantics, WirePortDataType dataType, string vertexDataName = null)
        {
            ...
            TemplateVertexData data = new(semantics, dataType, vertexDataName);
        ...
        public TemplateVertexData RequestNewInterpolator(WirePortDataType dataType, bool isColor, string varName = null, bool noInterpolationFlag = false, bool sampleFlag = false)
        {
            ...
            {
                TemplateInterpElement item = new(TemplateHelperFunctions.IntToSemantic[newInterpId]);
