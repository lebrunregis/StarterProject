...
namespace AmplifyShaderEditor
{
    ...
    public class MasterNode : OutputNode
    {
        ...
        // Shader Keywords
        [SerializeField]
        private List<string> m_shaderKeywords = new();
        ...
        protected GUIContent m_categoryLabel = new("Shader Type ", "Specify the shader type you want to be working on");

        protected GUIContent[] m_availableCategoryLabels;
        protected MasterNodeCategoriesData[] m_availableCategories;

        [SerializeField]
        private List<PropertyNode> m_propertyNodesVisibleList = new();
        ...
        public override void SetupNodeCategories()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    NodeData nodeData = new(m_inputPorts[i].Category);
                ...
                else if (m_inputPorts[i].HasExternalLink)
                {
                    ...
                    {
                        NodeData nodeData = new(linkedPort.Category);
