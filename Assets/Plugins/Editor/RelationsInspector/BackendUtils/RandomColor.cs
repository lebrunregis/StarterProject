...
namespace RelationsInspector.Backend
{
    public static class RandomColor
    {
        ...
        private static readonly Color[] LightPalette =
            new Color[]
            {
                new(0.78f, 0.12f, 0.22f)
                ,new(0.10f, 0.73f, 0.08f)
                ,new(0.60f, 0.37f, 0.08f)
                ,new(0.86f, 0.31f, 0.07f)
                ,new(0.68f, 0.20f, 0.20f)
                ,new(0.63f, 0.30f, 0.81f)
                ,new(0.77f, 0.64f, 0.06f)
                ,new(0.06f, 0.73f, 0.34f)
                ,new(0.59f, 0.36f, 0.30f)
                ,new(0.16f, 0.48f, 0.59f)
                ,new(0.79f, 0.20f, 0.65f)
            };
        ...
        private static readonly Color[] DarkPalette =
            new Color[]
             {
                new(0.78f, 0.12f, 0.22f)
                ,new(0.11f, 0.60f, 0.10f)
                ,new(0.60f, 0.37f, 0.08f)
                ,new(0.18f, 0.20f, 0.56f)
                ,new(0.68f, 0.20f, 0.20f)
                ,new(0.63f, 0.30f, 0.81f)
                ,new(0.60f, 0.49f, 0.05f)
                ,new(0.10f, 0.59f, 0.31f)
                ,new(0.59f, 0.36f, 0.30f)
                ,new(0.16f, 0.48f, 0.59f)
                ,new(0.66f, 0.13f, 0.54f)
            };
        ...
        private static readonly float maxShade = 0.75f;
