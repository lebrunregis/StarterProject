...
namespace AmplifyShaderEditor
{
    ...
    public class UIUtils
    {
        ...
        public static GUIStyle EmptyStyle = new();
        ...
        private static readonly string NumericNamePattern = @"^\d";
        private static System.Globalization.TextInfo m_textInfo;
        private static string m_latestOpenedFolder = string.Empty;
        private static Dictionary<int, UndoParentNode> m_undoHelper = new();

        private static readonly Dictionary<string, int> AvailableKeywordsDict = new();
        ...
        private static readonly Dictionary<string, int> AvailableURPKeywordsDict = new();
        ...
        private static readonly Dictionary<MasterNodePortCategory, int> m_portCategoryToArrayIdx = new()
        {
        ...
        private static readonly Dictionary<string, string> m_reservedPropertyNames = new()
        {
        ...
        private static Dictionary<string, string> m_exampleMaterialIDs = new()
        {
			//Community
        ...
        private static readonly Dictionary<TextureType, string> m_textureTypeToCgType = new()
        {
        ...
        private static readonly Dictionary<string, Color> m_nodeCategoryToColor = new()
        {
        ...
        private static readonly Dictionary<ToolButtonType, List<string>> m_toolButtonTooltips = new()
        {
        ...
        private static readonly Color[] m_dataTypeToColorMonoMode = { new(0.5f, 0.5f, 0.5f, 1.0f), Color.white };
        private static readonly Dictionary<WirePortDataType, Color> m_dataTypeToColor = new(new WirePortDataTypeComparer())
        {
        ...
        private static readonly Dictionary<WirePortDataType, string> m_dataTypeToName = new()
        {
        ...
        private static readonly Dictionary<SurfaceInputs, string> m_inputTypeDeclaration = new()
        {
            ...
            { SurfaceInputs.FRONT_FACE_VFACE, Constants.IsFrontFaceInputVFACE},
            { SurfaceInputs.INTERNALDATA, Constants.InternalData}
        };

        private static readonly Dictionary<SurfaceInputs, string> m_inputTypeName = new()
        {
        ...
        private static readonly Dictionary<PrecisionType, string> m_precisionTypeToCg = new()
        {
        ...
        private static readonly Dictionary<VariableQualifiers, string> m_qualifierToCg = new()
        {
        ...
        private static readonly Dictionary<WirePortDataType, string> m_precisionWirePortToCgType = new()
        {
        ...
        private static readonly Dictionary<WirePortDataType, string> m_precisionWirePortToStandardMacroType = new()
        {
            {WirePortDataType.FLOAT,       "{0}"},
            {WirePortDataType.FLOAT2,       "{0}2"},
            {WirePortDataType.FLOAT3,       "{0}3"},
        ...
        private static readonly Dictionary<WirePortDataType, string> m_precisionWirePortToSRPMacroType = new()
        {
            {WirePortDataType.FLOAT,       "{0}"},
            {WirePortDataType.FLOAT2,       "{0}2"},
            {WirePortDataType.FLOAT3,       "{0}3"},
        ...
        private static readonly Dictionary<WirePortDataType, string> m_wirePortToCgType = new()
        {
            { WirePortDataType.FLOAT,       "float"},
        ...
        private static readonly Dictionary<KeyCode, string> m_keycodeToString = new()
        {
            {KeyCode.Alpha0,"0" },
            {KeyCode.Alpha1,"1" },
            {KeyCode.Alpha2,"2" },
        ...
        private static readonly Dictionary<WireStatus, Color> m_wireStatusToColor = new()
        {
        ...
        private static readonly Dictionary<WirePortDataType, string> m_autoSwizzle = new()
        {
        ...
        private static readonly Dictionary<string, bool> m_unityNativeShaderPaths = new()
        {
            { "Resources/unity_builtin_extra", true },
            { "Library/unity default resources", true }
        };

        private static readonly Dictionary<WirePortDataType, int> m_portPriority = new()
        {
        ...
        private static readonly EditorGUIUtility obj = new();
        private static MethodInfo drawColorSwatchMI = null;
