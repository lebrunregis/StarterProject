...
namespace AmplifyShaderEditor
{
    ...
    public sealed class OutlineOpHelper
    {
        ...
        private readonly string[] ModeTags =
        {
            "Tags{ }",
        ...
        private readonly string[] ModePragma =
        {
            string.Empty,
            string.Empty,
            "alpha:fade ",
        ...
        private readonly bool[] m_colorMask = { true, true, true, true };
        ...
        private List<PropertyDataCollector> m_inputList = new();
        private string m_uniforms = string.Empty;
        private List<PropertyDataCollector> m_uniformList = new();
        private List<PropertyDataCollector> m_instancedPropertiesList = new();
        ...
        private void AddMultibodyString(string body, List<string> list)
        {
