...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateTagsModuleData : TemplateModuleData
    {
        ...
        public List<TemplatesTagData> Tags = new();
        public void Destroy()
        {
            Tags.Clear();
            Tags = null;
    ...
    public static class TemplateHelperFunctions
    {
		...
		*/
        ...
        public static readonly Dictionary<string, CustomTemplatePropertyUIEnum> CustomTemplatePropertyUI = new()
        {
            { "None", CustomTemplatePropertyUIEnum.None},
            { "HDPBR", CustomTemplatePropertyUIEnum.HDPBR}
        };

        public static readonly Dictionary<string, InvisibleOptionsEnum> InvisibleOptions = new()
        {
            { "SyncP", InvisibleOptionsEnum.SyncProperties }
        };

        public static readonly Dictionary<string, TemplateSpecialTags> StringToReservedTags = new()
        {
        ...
        public static readonly Dictionary<string, DisableBatching> StringToDisableBatching = new()
        {
        ...
        public static readonly Dictionary<string, RenderType> StringToRenderType = new()
        {
        ...
        public static readonly Dictionary<string, RenderQueue> StringToRenderQueue = new()
        {
        ...
        public static readonly Dictionary<string, WirePortDataType> PropertyToWireType = new()
        {
        ...
        public static readonly Dictionary<WirePortDataType, int> DataTypeChannelUsage = new()
        {
        ...
        public static readonly Dictionary<int, WirePortDataType> ChannelToDataType = new()
        {
        ...
        public static readonly Dictionary<TemplateSemantics, string> SemanticsDefaultName = new()
        {
        ...
        public static readonly Dictionary<int, TemplateInfoOnSematics> IntToInfo = new()
        {
        ...
        public static readonly Dictionary<string, TemplateInfoOnSematics> ShortcutToInfo = new()
        {
        ...
        public static readonly Dictionary<TemplateInfoOnSematics, string> InfoToDefineFrag = new()
        {
        ...
        public static readonly Dictionary<TemplateInfoOnSematics, string> InfoToDefineVertex = new()
        {
        ...
        public static readonly Dictionary<TemplateInfoOnSematics, string> InfoToDefine = new()
        {
        ...
        public static readonly Dictionary<TemplateInfoOnSematics, string> InfoToLocalVar = new()
        {
        ...
        public static readonly Dictionary<TemplateInfoOnSematics, WirePortDataType> InfoToWirePortType = new()
        {
        ...
        public static readonly Dictionary<int, TemplateInfoOnSematics> IntToUVChannelInfo = new()
        {
            {0,TemplateInfoOnSematics.TEXTURE_COORDINATES0 },
            {1,TemplateInfoOnSematics.TEXTURE_COORDINATES1 },
            {2,TemplateInfoOnSematics.TEXTURE_COORDINATES2 },
        ...
        public static readonly Dictionary<int, TemplateSemantics> IntToSemantic = new()
        {
        ...
        public static readonly Dictionary<TemplateSemantics, int> SemanticToInt = new()
        {
        ...
        public static readonly Dictionary<string, TemplateSemantics> ShortcutToSemantic = new()
        {
        ...
        public static readonly Dictionary<string, WirePortDataType> CgToWirePortType = new()
        {
            {"float"            ,WirePortDataType.FLOAT},
        ...
        public static readonly Dictionary<string, int> AvailableInterpolators = new()
        {
            {"2.0",8 },
            {"2.5",8 },
            {"3.0",10},
        ...
        public static readonly Dictionary<string, int> ShaderModelToArrayIdx = new()
        {
            {"2.0",0},
            {"2.5",1},
            {"3.0",2},
        ...
        public static readonly Dictionary<string, TemplateSRPType> TagToRenderPipeline = new()
        {
        ...
        public static void CreateShaderPropertiesList(string propertyData, ref List<TemplateShaderPropertyData> propertiesList, ref Dictionary<string, TemplateShaderPropertyData> duplicatesHelper, int subShaderId, int passId)
        {
            ...
            foreach (Match match in Regex.Matches(propertyData, PropertiesPatternI, RegexOptions.Multiline))
            {
                if (match.Groups.Count > 1)
                {
                    ...
                    {
                        TemplateShaderPropertyData newData = new(match.Index,
                                                                                                match.Value,
        ...
        public static void CheckUnityBuiltinGlobalMacros(string propertyData, ref List<TemplateShaderPropertyData> propertiesList, ref Dictionary<string, TemplateShaderPropertyData> duplicatesHelper, int subShaderId, int passId)
        {
            ...
            if (match.Success)
            {
                TemplateShaderPropertyData newData = new(-1,
                                                                                            string.Empty,
                                                                                            string.Empty,
                                                                                            string.Empty,
                ...
                if (match.Groups.Count == 4)
                {
                    if (CgToWirePortType.ContainsKey(match.Groups[2].Value))
                    {
                        ...
                        if (!string.IsNullOrEmpty(match.Groups[1].Value) && ShortcutToInfo.ContainsKey(match.Groups[1].Value))
                        {
                            ...
                            TemplateLocalVarData data = new(ShortcutToInfo[match.Groups[1].Value], id, CgToWirePortType[match.Groups[2].Value], category, match.Groups[3].Value, match.Index);
                            localVarList.Add(data);
                        }
                        else
                        {
                            TemplateLocalVarData data = new(CgToWirePortType[match.Groups[2].Value], category, match.Groups[3].Value, match.Index);
                            localVarList.Add(data);
                        }
        ...
        public static List<TemplateVertexData> CreateVertexDataList(string vertexData, string parametersBody)
        {
            ...
            foreach (Match match in Regex.Matches(vertexData, VertexDataPattern))
            {
                if (match.Groups.Count > 1)
                {
                    ...
                    TemplateVertexData templateVertexData = new(semantics, dataType, varName);
            ...
            if (vertexData.Contains(Constants.InstanceIdMacro))
            {
                ...
                TemplateVertexData templateVertexData = new(TemplateSemantics.SV_InstanceID, WirePortDataType.UINT, Constants.InstanceIdVariable);
        ...
        public static TemplateInterpData CreateInterpDataList(string interpData, string fullLine, int maxInterpolators)
        {
            ...
            if (rangeMatch.Groups.Count > 0)
            {
                ...
                {
                    TemplateVertexData templateInterpData = new(TemplateSemantics.SV_InstanceID, WirePortDataType.UINT, Constants.InstanceIdVariable);
                ...
                Dictionary<string, TemplateVertexData> auxDict = new();
                        ...
                        if (paramDataArr.Length == 2)
                        {
                            ...
                            if (interpDataDict.ContainsKey(semantic))
                            {
                                if (interpDataDict[semantic] != null)
                                {
                                    ...
                                    {
                                        TemplateVertexData templateInterpData = new(interpDataDict[semantic]);
                                        if (swizzleInfoArr.Length > 1)
                                        {
                                            templateInterpData.DataSwizzle = "." + swizzleInfoArr[1];
                                        }
