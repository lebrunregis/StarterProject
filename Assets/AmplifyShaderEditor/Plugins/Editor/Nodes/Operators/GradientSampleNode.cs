...
namespace AmplifyShaderEditor
{
    ...
    public sealed class GradientSampleNode : ParentNode
    {
        ...
        private readonly string m_functionHeaderStruct = "Gradient( {0} )";
        ...
        private GradientNode RecursiveBackCheck(ParentNode node)
        {
        ...
        private void GenerateGradientSampler(bool isSrp)
        {
