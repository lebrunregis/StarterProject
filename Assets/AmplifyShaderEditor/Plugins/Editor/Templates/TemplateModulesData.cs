...
namespace AmplifyShaderEditor
{
    ...
    {
        [SerializeField]
        private TemplateRenderPlatformHelper m_renderPlatformHelper;

        [SerializeField]
        private TemplateBlendData m_blendData = new();

        [SerializeField]
        private TemplateBlendData m_blendData1 = new();

        [SerializeField]
        private TemplateBlendData m_blendData2 = new();

        [SerializeField]
        private TemplateBlendData m_blendData3 = new();

        [SerializeField]
        private TemplateAlphaToMaskData m_alphaToMaskData = new();

        [SerializeField]
        private TemplateCullModeData m_cullModeData = new();

        [SerializeField]
        private TemplateColorMaskData m_colorMaskData = new();

        [SerializeField]
        private TemplateColorMaskData m_colorMaskData1 = new();

        [SerializeField]
        private TemplateColorMaskData m_colorMaskData2 = new();

        [SerializeField]
        private TemplateColorMaskData m_colorMaskData3 = new();

        [SerializeField]
        private TemplateStencilData m_stencilData = new();

        [SerializeField]
        private TemplateDepthData m_depthData = new();

        [SerializeField]
        private TemplateTagsModuleData m_tagData = new();

        [SerializeField]
        private TemplateTagData m_globalsTag = new(TemplatesManager.TemplateGlobalsTag, true);

        [SerializeField]
        private TemplateTagData m_srpBatcherTag = new(TemplatesManager.TemplateSRPBatcherTag, true);

        [SerializeField]
        private TemplateTagData m_allModulesTag = new(TemplatesManager.TemplateAllModulesTag, true);

        [SerializeField]
        private TemplateTagData m_functionsTag = new(TemplatesManager.TemplateFunctionsTag, true);

        [SerializeField]
        private TemplateTagData m_pragmaTag = new(TemplatesManager.TemplatePragmaTag, true);

        [SerializeField]
        private TemplateTagData m_pragmaBeforeTag = new(TemplatesManager.TemplatePragmaBeforeTag, true);

        [SerializeField]
        private TemplateTagData m_passTag = new(TemplatesManager.TemplatePassTag, true);

        [SerializeField]
        private TemplateTagData m_inputsVertTag = new(TemplatesManager.TemplateInputsVertParamsTag, false);

        [SerializeField]
        private TemplateTagData m_inputsFragTag = new(TemplatesManager.TemplateInputsFragParamsTag, false);

        [SerializeField]
        private TemplateShaderModelData m_shaderModel = new();
        ...
        [SerializeField]
        private TemplateIncludePragmaContainter m_includePragmaContainer = new();
        ...
        public void TestPropertyInternalName(string name, ref List<TemplateShaderPropertyData> availableShaderProperties, ref Dictionary<string, TemplateShaderPropertyData> duplicatesHelper)
        {
            ...
            {
                TemplateShaderPropertyData newData = new(-1, string.Empty, string.Empty, name, name, WirePortDataType.INT, PropertyType.Property, -1, -1);
