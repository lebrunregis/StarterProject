...
namespace AmplifyShaderEditor
{
    ...
    public class ShortcutsManager
    {
        ...
        private Dictionary<KeyCode, Dictionary<EventModifiers, ShortcutItem>> m_editorShortcutsDict = new();
        private Dictionary<KeyCode, ShortcutItem> m_editorNoModifiersShortcutsDict = new();
        private List<ShortcutItem> m_editorShortcutsList = new();

        private Dictionary<KeyCode, ShortcutItem> m_nodesShortcutsDict = new();
        private List<ShortcutItem> m_nodesShortcutsList = new();
        ...
        public void RegisterEditorShortcut(bool showOnList, EventModifiers modifiers, KeyCode key, string description, ShortcutItem.ShortcutFunction myKeyDownFunctionPtr, ShortcutItem.ShortcutFunction myKeyUpFunctionPtr = null)
        {
            ...
            ShortcutItem item = new(((modifiers == EventModifiers.None || modifiers == EventModifiers.FunctionKey) ? key.ToString() : modifiers + " + " + key), description, myKeyDownFunctionPtr, myKeyUpFunctionPtr);
        ...
        public void RegisterEditorShortcut(bool showOnList, KeyCode key, string description, ShortcutItem.ShortcutFunction myKeyDownFunctionPtr, ShortcutItem.ShortcutFunction myKeyUpFunctionPtr = null)
        {
            ...
            ShortcutItem item = new(key.ToString(), description, myKeyDownFunctionPtr, myKeyUpFunctionPtr);
