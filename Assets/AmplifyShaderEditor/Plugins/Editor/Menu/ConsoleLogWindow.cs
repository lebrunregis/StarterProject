...
namespace AmplifyShaderEditor
{
    ...
    public class ConsoleLogWindow
    {
        ...
        private readonly GUIContent m_boxToggleContent = new("\u2261", "Toggle Message Box");
        private readonly GUIContent m_clearContent = new("\u00D7", "Clear Messages");
        ...
        public void AddMessage(MessageSeverity itemType, string itemMessage, int itemOwnerId)
        {
            ...
            GUIContent gc = new(m_parentWindow.Messages.Count + ": " + itemMessage);
        ...
        public void Draw(Rect parentPosition, Vector2 mousePosition, int mouseButtonId, bool hasKeyboadFocus, float rightSide)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    GUIContent gc = new(messages[i].ItemMessage);
