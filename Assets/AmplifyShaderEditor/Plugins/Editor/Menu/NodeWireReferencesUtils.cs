...
namespace AmplifyShaderEditor
{
    ...
    {
        public WireReference InputPortReference = new();
        public WireReference SwitchPortReference = new();
        public WireReference OutputPortReference = new();

        public Vector2 SnapPosition = Vector2.zero;
        public bool SnapEnabled = false;
        public WireReference SnapPort = new();
