...
namespace AmplifyShaderEditor
{
    ...
    public sealed class TemplateMultiPass : TemplateDataParent
    {
        ...
        [SerializeField]
        private List<TemplateSubShader> m_subShaders = new();
        ...
        [SerializeField]
        private TemplateInfoContainer m_customInspectorContainer = new();

        [SerializeField]
        private TemplateInfoContainer m_dependenciesContainer = new();

        [SerializeField]
        private TemplateInfoContainer m_fallbackContainer = new();

        [SerializeField]
        private TemplateInfoContainer m_beforePragmaContainer = new();
        ...
        [SerializeField]
        private TemplateShaderModelData m_globalShaderModel = new();

        private readonly Dictionary<string, TemplateUniquePassData> m_passUniqueIdData = new();
        ...
        private void LoadTemplateBody(string guid, string path)
        {
            ...
            {
                TemplateSubShader subShader = new(this, i, m_templateIdManager, "SubShader" + i, m_shaderData.SubShaders[i], ref duplicatesHelper);
