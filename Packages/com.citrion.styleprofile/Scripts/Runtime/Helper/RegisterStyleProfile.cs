...
namespace CitrioN.StyleProfileSystem
{
    ...
    /// </summary>
    [AddTooltips]
    [HeaderInfo("Helper script to register a StyleProfile for runtime queries. " +
                "Useful to ensure the required style profile is registered if using style profile identifiers.")]
