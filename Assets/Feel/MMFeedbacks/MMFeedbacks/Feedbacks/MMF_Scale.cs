...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Scale : MMF_Feedback
    {
        ...
        public MMTweenType AnimateScaleTweenX = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1.5f), new Keyframe(1, 0)), "AnimateX");
        ...
        public MMTweenType AnimateScaleTweenY = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1.5f), new Keyframe(1, 0)), "AnimateY");
        ...
        public MMTweenType AnimateScaleTweenZ = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1.5f), new Keyframe(1, 0)), "AnimateZ");
