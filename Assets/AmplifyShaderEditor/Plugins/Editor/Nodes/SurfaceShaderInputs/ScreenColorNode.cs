...
namespace AmplifyShaderEditor
{
    ...
    public sealed class ScreenColorNode : PropertyNode
    {
        ...
        private readonly Color ReferenceHeaderColor = new(0.6f, 3.0f, 1.25f, 1.0f);
        ...
        private readonly string LWFetchOpaqueTexture = "float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( {0}.xy ), 1.0 )";
        ...
        public override void OnNodeLogicUpdate(DrawInfo drawInfo)
        {
            ...
            {
                m_referenceNode = UIUtils.GetScreenColorNode(m_referenceNodeId);
...
#if UNITY_2021_1_OR_NEWER
            if ((ContainerGraph.IsLWRP || ContainerGraph.ParentWindow.IsShaderFunctionWindow) && ASEPackageManagerHelper.CurrentHDRPBaseline >= ASESRPBaseline.ASE_SRP_11_0)
            {
