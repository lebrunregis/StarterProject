...
namespace AmplifyShaderEditor
{
    ...
    public class TemplateIdManager
    {
        ...
        [SerializeField]
        private List<TemplateId> m_registeredIds = new();

        [SerializeField]
        private List<TemplateTag> m_registeredTags = new();

        [SerializeField]
        private List<TemplatePassId> m_registeredPassIds = new();

        private Dictionary<string, TemplateId> m_registeredIdsDict = new();
        ...
        public void RegisterId(int bodyIdx, string uniqueID, string tag, bool emptyReplacer = false)
        {
            ...
            TemplateId templateId = new(bodyIdx, uniqueID, tag, emptyReplacer);
