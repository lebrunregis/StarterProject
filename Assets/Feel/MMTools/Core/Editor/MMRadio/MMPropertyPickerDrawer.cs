...
namespace MoreMountains.Tools
{
    ...
    public class MMPropertyPickerDrawer : PropertyDrawer
    {
        ...
        private readonly Dictionary<string, PropertyPickerViewData> _propertyPickerViewData = new();
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                viewData._TargetObject = property.FindPropertyRelative("TargetObject").objectReferenceValue;
                FillComponentsList(property, viewData);
