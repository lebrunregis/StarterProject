...
namespace AmplifyShaderEditor
{
    ...
    public class TemplatePass
    {
        ...
        [SerializeField]
        private TemplatePropertyContainer m_templateProperties = new();

        [SerializeField]
        private List<TemplateShaderPropertyData> m_availableShaderGlobals = new();

        [SerializeField]
        private TemplateInfoContainer m_passNameContainer = new();
#if CUSTOM_OPTIONS_AVAILABLE
        [SerializeField]
        private TemplateOptionsContainer m_customOptionsContainer = new();
#endif
        public TemplatePass(TemplateMultiPass template, TemplateSubShader subShader, int subshaderIdx, int passIdx, TemplateIdManager idManager, string uniquePrefix, int offsetIdx, TemplatePassInfo passInfo, ref Dictionary<string, TemplateShaderPropertyData> duplicatesHelper)
        {
            ...
            Dictionary<string, TemplateShaderPropertyData> ownDuplicatesDict = new(duplicatesHelper);
        ...
        private void FetchPassName(int offsetIdx, string body)
        {
        ...
        private void FetchTessellationData(TemplateMultiPass template, TemplateModulesData subShaderModule, int offsetIdx, string body)
        {
        ...
        private void FetchVertexAndInterpData(TemplateMultiPass template, TemplateModulesData subShaderModule, int offsetIdx, string body)
        {
            // Vertex Data
            try
            {
        ...
        private void FetchCodeAreas(int offsetIdx, string begin, MasterNodePortCategory category, string body)
        {
        ...
        private void FetchInputs(int offset, MasterNodePortCategory portCategory, string body)
        {
