...
namespace AmplifyShaderEditor
{
	...
	*/
    ...
    public class TemplateActionItem
    {
        ...
        //COLOR MASK
        public ItemColorMask ColorMask = new();
        public ItemColorMask ColorMask1 = new();
        public ItemColorMask ColorMask2 = new();
        public ItemColorMask ColorMask3 = new();
    ...
    public class TemplateOptionsItem
    {
        ...
        [SerializeField]
        public InlineProperty FieldValue = new();
    ...
    public class TemplateOptionsContainer
    {
        ...
        public void CopyPortOptionsFrom(TemplateOptionsContainer container, string passName)
        {
            ...
            List<TemplateOptionsItem> newItems = new();
    ...
    public class TemplateOptionsToolsHelper
    {
        ...
        public static Dictionary<string, AseOptionsSetup> AseOptionsSetupDict = new()
        {
        ...
        public static Dictionary<string, AseOptionsUIWidget> AseOptionsUITypeDict = new()
        {
            { "Dropdown",AseOptionsUIWidget.Dropdown },
            { "Toggle", AseOptionsUIWidget.Toggle }
        };

        public static Dictionary<string, AseOptionsActionType> AseOptionsActionTypeDict = new()
        {
        ...
        public static Dictionary<string, AseOptionItemSetup> AseOptionItemSetupDict = new()
        {
        ...
        {
            TemplateOptionsContainer optionsContainer = new();
            ...
            if (match.Success)
            {
                try
                {
                    ...
                    List<TemplateOptionsItem> optionItemsList = new();
                    List<List<TemplateActionItem>> actionItemsList = new();
                    Dictionary<string, int> optionItemToIndex = new();
        ...
        private static void FillOptionAction(TemplateOptionsItem currentOption, ref List<List<TemplateActionItem>> actionItemsList)
        {
        ...
        private static TemplateActionItem CreateActionItem(bool isSubshader, string[] optionItems, TemplateActionItemConditional condition = null)
        {
            TemplateActionItem actionItem = new();
            try
            {
