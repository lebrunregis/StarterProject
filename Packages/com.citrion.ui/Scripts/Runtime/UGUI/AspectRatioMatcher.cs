...
namespace CitrioN.UI
{
    ...
    [ExecuteAlways]
    [AddTooltips]
    [HeaderInfo("Matches a RectTransform's size based on the specified criterias. " +
                "Can for example force a RectTransform to be squared by matching its width to its height with a ratio of 1.")]
