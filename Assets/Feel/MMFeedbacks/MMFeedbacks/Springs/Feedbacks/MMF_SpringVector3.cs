...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_SpringVector3 : MMF_Feedback
    {
        ...
        public Vector3 MoveToValue = new(2f, 2f, 2f);
        ...
        public Vector3 BumpAmount = new(75f, 75f, 75f);
        ...
        public Vector3 MoveToRandomValueMin = new(-2f, -2f, -2f);
        ...
        [MMEnumCondition("Command", (int)SpringCommands.MoveToRandom)]
        public Vector3 MoveToRandomValueMax = new(2f, 2f, 2f);
        ...
        public Vector3 BumpAmountRandomValueMin = new(-20f, -20f, -20f);
        ...
        [MMEnumCondition("Command", (int)SpringCommands.BumpRandom)]
        public Vector3 BumpAmountRandomValueMax = new(20f, 20f, 20f);
        ...
        public Vector3 NewDamping = new(0.8f, 0.8f, 0.8f);
        ...
        public Vector3 NewFrequency = new(5f, 5f, 5f);
