...
namespace CitrioN.SettingsMenuCreator
{
    ...
    public partial class SettingsCollection : ScriptableObject
    {
        ...
        protected List<SettingHolder> settings = new();
    ...
    protected UnityEngine.Rendering.PostProcessing.PostProcessProfile postProcessProfile;
        ...
        public Dictionary<string, object[]> pendingSettingChanges = new();

        public Dictionary<string, object> activeSettingValues = new();

        public Dictionary<string, object> tempSettingValues = new();

        public Dictionary<Setting, object> startValues = new();
