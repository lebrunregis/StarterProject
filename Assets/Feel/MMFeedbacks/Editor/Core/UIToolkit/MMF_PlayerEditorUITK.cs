...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_PlayerEditorUITK : Editor
    {
        ...
        protected StyleColor _transparentColor = new(new Color(0, 0, 0, 0));
        ...
        public virtual void DrawDurationAndDirectionContents()
        {
            ...
            Label durationLabel = new("[" + TargetMmfPlayer.TotalDuration.ToString("F2") + "s]");
            durationLabel.AddToClassList(_settingsDurationClassName);
            _settingsInfo.Add(durationLabel);

            // direction icon
            VisualElement directionIcon = new();
        ...
        protected virtual void DrawFeedbacksInactiveWarning(VisualElement root)
        {
            ...
            {
                VisualElement feedbacksInactiveWarning = new();
                feedbacksInactiveWarning.AddToClassList(_inactiveWarningClassName);
                Label feedbacksInactiveLabel = new(_inactiveMessage);
        ...
        protected virtual void DrawSettingsDropDown(VisualElement root)
        {
            ...
            // icon on the left
            VisualElement settingsIcon = new();
            ...
            PropertyField onlyPlayIfWithinRangeField =
                new(serializedObject.FindProperty(_onlyPlayIfWithinRangePropertyName));
            ...
            PropertyField useRangeFalloffField =
                new(serializedObject.FindProperty(_useRangeFalloffPropertyName));
            rangeContainer.Add(useRangeFalloffField);
            settingsRangeFoldout.Add(rangeContainer);

            // range falloff container
            VisualElement rangeFalloffContainer = new();
            ...
            // events foldout
            PropertyField eventsField = new(serializedObject.FindProperty(_eventsSectionText));
        ...
        protected virtual void DrawAutomaticShakerSetupButton()
        {
            ...
            {
                Button automaticShakerSetupButton = new(() => TargetMmfPlayer.AutomaticShakerSetup());
        ...
        protected virtual void DrawFeedbacksList(VisualElement root)
        {
            ...
            VisualElement feedbacksListContainer = new();
        ...
        protected virtual void DrawEmptyListState()
        {
            ...
            {
                VisualElement emptyListImage = new();
        ...
        protected virtual void AssembleFeedbacksList()
        {
            ...
            _feedbacksListView.bindItem = (element, index) =>
            {
                ...
                Button scriptEditButton = new(() => EditScript(feedbackType));
                scriptEditButton.text = feedbackType.Name;
                scriptEditButtonBox.Add(scriptEditButton);
                VisualElement scriptEditSelectorIcon = new();
                ...
                // progress line
                VisualElement feedbackProgressBarContainer = new();
                ...
                VisualElement feedbackProgressBar = new();
                ...
                // setup required
                VisualElement setupRequiredWarningBox = new();
                setupRequiredWarningBox.AddToClassList(_feedbackSetupRequiredBoxClassName);
                setupRequiredWarningBox.focusable = false;
                Label setupRequiredLabel = new(TargetMmfPlayer.FeedbacksList[index].RequiresSetupText);
                ...
                MMFInspectorDrawData drawData = new();
                ...
                VisualElement feedbackInspectorContainer = new();
                ...
                VisualElement feedbackLeftBorder = new();
                ...
                {
                    VisualElement feedbackBackgroundColor = new();
                ...
                VisualElement feedbackHeaderContainer = new();
                ...
                FeedbackHeaderContainersData feedbackHeaderContainersData = new();
                ...
                ContextualMenuManipulator contextualMenuManipulator = new((evt) =>
                {
            ...
            FeedbackHeaderContainersData feedbackHeaderContainersData)
        {
            ...
            VisualElement contextMenuIcon = new();
            ...
            // target 
            Label targetLabel = new(TargetMmfPlayer.FeedbacksList[index].RequiredTarget);
            ...
            Label timingLabel = new(timingInfo);
            ...
            {
                VisualElement setupRequiredIcon = new();
        ...
        {
            VisualElement bottomBarContents = new();
            bottomBarContents.style.flexDirection = FlexDirection.Column;

            // setup bar row and results row
            VisualElement controlsRow = new();
            VisualElement searchResultsRow = new();
            ...
            PopupField<string> addNewFeedbackPopupField =
                new(_addNewFeedbackPopupFieldLabel, _typeDisplays, 0);
            ...
            {
                Button copyAllButton = new(CopyAll) { text = _copyAllText };
            ...
            {
                Button pasteAsNewButton = new(PasteAsNew) { text = _pasteAsNewText };
            ...
            if (MMF_PlayerCopy.HasMultipleCopies())
            {
                Button replaceAllButton = new(ReplaceAll) { text = _replaceAllText };
                Button pasteAllAsNewButton = new(PasteAllAsNew) { text = _pasteAllAsNewText };
        ...
        protected virtual void BuildSearchField(VisualElement anchor, VisualElement resultsVisualElement)
        {
            ...
            // clear button
            Button clearSearchFieldButton = new(ClearSearchField);
            ...
            void OnSearchFieldValueChanged(ChangeEvent<string> evt)
            {
                ...
                List<string> filteredFeedbackNames = new(_typeNamesDisplays);
                ...
                {
                    Button addFeedbackButton = new(() => AddFeedbackByName(feedbackName, searchField)) { text = feedbackName };
        ...
        {
            VisualElement controlsContainer = new();
            ...
            Button initializeButton = new(() => TargetMmfPlayer.Initialization()) { text = _initializeText };
            Button playButton = new(() => TargetMmfPlayer.PlayFeedbacks()) { text = _playText };
            Button pauseButton = new(() => TargetMmfPlayer.PauseFeedbacks()) { text = _pauseText };
            Button stopButton = new(() => TargetMmfPlayer.StopFeedbacks()) { text = _stopText };
            Button resetButton = new(() => TargetMmfPlayer.ResetFeedbacks()) { text = _resetText };
            ...
            Button skipButton = new(() => TargetMmfPlayer.SkipToTheEnd()) { text = _skipText };
            Button restoreButton = new(() => TargetMmfPlayer.RestoreInitialValues()) { text = _restoreText };
            Button changeDirectionButton = new(() => TargetMmfPlayer.ChangeDirection())
            ...
            Button keepPlaymodeChangesButton = new() { text = _keepPlaymodeChangesText };
            ...
            // resume button
            Button resumeButton = new(() => TargetMmfPlayer.ResumeFeedbacks()) { text = _resumeText };
