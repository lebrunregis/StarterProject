...
namespace AmplifyShaderEditor
{
    ...
    public class ShaderBodyTokenTable
    {
        ...
        private readonly LinkedList<TokenDesc> tokens = new();
        private readonly Dictionary<string, List<LinkedListNode<TokenDesc>>> tokensByName = new();
        private readonly Dictionary<int, List<LinkedListNode<TokenDesc>>> tokensByLine = new();

        private static readonly List<LinkedListNode<TokenDesc>> EmptyTokenList = new();
